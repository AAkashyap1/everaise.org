...
function loadBundle(data) {
    return database4e94304b.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database4e94304b.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database4e94304b.Query$1(this, 
...
registerBundle(database4e94304b.Firestore);
