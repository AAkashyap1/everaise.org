 ...
 */ function S(t) {
    ...
    if (A.logLevel <= c.DEBUG) {
        var r = e.map(R);
        A.debug.apply(A, _([ "Firestore (8.6.3): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (A.logLevel <= c.ERROR) {
        var r = e.map(R);
        A.error.apply(A, _([ "Firestore (8.6.3): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (A.logLevel <= c.WARN) {
        var r = e.map(R);
        A.warn.apply(A, _([ "Firestore (8.6.3): " + t ], r));
    }
}
...
/** Creates a deep copy of `source`. */ function gt(t) {
    ...
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, X(t.timestampValue))
    };
    if (t.mapValue) {
        var e = {
            mapValue: {
        ...
        return B(t.mapValue.fields, (function(t, n) {
 ...
 */ var wt = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!mt(e = (e.mapValue.fields || {})[t.get(n)])) return null;
...
var _t = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , x.min(), wt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, wt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, wt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function It(t) {
    ...
    if (null === e.h) {
        ...
        n += Mt(e.startAt)), e.endAt && (n += "|ub:", n += Mt(e.endAt)), e.h = n;
    }
    return e.h;
}
...
var St = /** @class */ function(t) {
     ...
     */    return g(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new Dt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Lt(t, r) : "in" /* IN */ === n ? new Ot(t, r) : "not-in" /* NOT_IN */ === n ? new Pt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Vt(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
        return "in" /* IN */ === e ? new kt(t, n) : new Rt(t, n);
...
var Dt = /** @class */ function(t) {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "in" /* IN */ , n) || this).keys = Ct("in" /* IN */ , n), 
        r;
    }
    return g(e, t), e.prototype.matches = function(t) {
...
}(St), Rt = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "not-in" /* NOT_IN */ , n) || this).keys = Ct("not-in" /* NOT_IN */ , n), 
        r;
    }
    return g(e, t), e.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function Ct(t, e) {
    var n;
...
/** A Filter that implements the IN operator. */ function Mt(t) {
    // TODO(b/29183165): Make this collision robust.
 ...
 */ function Yt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Ut(n)), e.p.push(new Ut(W.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function Xt(t) {
    var e = O(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Tt(e.path, e.collectionGroup, Yt(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
...
function $t(t, e) {
    return At(Xt(t), Xt(e)) && t.limitType === e.limitType;
}
...
function te(t) {
    return "Query(target=" + function(t) {
        ...
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Mt(t.startAt)), t.endAt && (e += ", endAt: " + Mt(t.endAt)), 
        "Target(" + e + ")";
...
/** Returns whether `doc` matches the constraints of `query`. */ function ee(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !qt(t.startAt, Yt(t), e)) && (!t.endAt || !qt(t.endAt, Yt(t), e));
    }(t, e);
}
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var ue = function() {
 ...
 */ function ae(t, e, n) {
    ...
    }(n, e) : t instanceof fe ? de(t, e) : t instanceof pe ? ye(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = he(t, e), r = me(n) + me(t.A);
        return dt(n) && dt(t.A) ? oe(r) : ie(t.R, r);
    }(t, e);
}
 ...
 */ function ce(t, e, n) {
    ...
    // applications.
    return t instanceof fe ? de(t, e) : t instanceof pe ? ye(t, e) : n;
}
 ...
 */ function he(t, e) {
    return t instanceof ve ? dt(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var le = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return g(e, t), e;
}(ue), fe = /** @class */ function(t) {
    function e(e) {
        var n = this;
...
/** Transforms an array value via a remove operation. */ var pe = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).elements = e, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var we = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function Ee(t, e) {
 ...
 */ function Ie(t, e, n) {
    t instanceof ke ? function(t, e, n) {
        ...
        if (Ee(t.precondition, e)) {
            var r = Le(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(Ce(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Ae(t, e, n) {
    t instanceof ke ? function(t, e, n) {
        if (Ee(t.precondition, e)) {
            var r = t.value.clone(), i = Oe(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(De(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof Re ? function(t, e, n) {
        if (Ee(t.precondition, e)) {
            var r = Oe(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Ce(t)), i.setAll(r), e.convertToFoundDocument(De(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Ee(t.precondition, e) && 
 ...
 */ function Ne(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = he(o.transform, s || null);
        null != u && (null == n && (n = wt.empty()), n.set(o.field, u));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && M(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof fe && e instanceof fe || t instanceof pe && e instanceof pe ? M(t.elements, e.elements, st) : t instanceof ve && e instanceof ve ? st(t.A, e.A) : t instanceof le && e instanceof le;
 ...
 */ function Oe(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, ae(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var Pe, Ve, Fe = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
...
var Ke = /** @class */ function() {
    function t(t) {
        this.comparator = t, this.data = new Be(this.comparator);
    }
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new Qe(this.data.getIterator());
    }, t.prototype.getIteratorFrom = function(t) {
        return new Qe(this.data.getIteratorFrom(t));
    }, 
...
}(), We = new Be(it.comparator);

function ze() {
    return We;
}

var He = new Be(it.comparator);

function Ye() {
    return He;
}

var Xe = new Be(it.comparator);

function Je() {
    return Xe;
}

var $e = new Ke(it.comparator);
 ...
 */ var nn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, rn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(x.min(), r, en(), ze(), Ze());
    }, t;
}(), rn = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Nt(i)) if (0 === n) {
                ...
                // queries.
                var o = new it(i.path);
                this.tt(e, o, _t.newNoDocument(o, x.min()));
    ...
    t.prototype.ut = function(t) {
        ...
        var i = new nn(t, n, this.Y, this.H, r);
        return this.H = ze(), this.J = hn(), this.Y = new Ke(F), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new Ke(F), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.it = function(t) {
        var e = this;
        this.G.set(t, new an), this.W.getRemoteKeysForTarget(t).forEach((function(n) {
...
function kn(t, e) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Ln(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = Ln(e.endAt)), n;
}
...
function Rn(t) {
    var e = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? K.emptyPath() : An(e);
    ...
    var s = [];
    n.where && (s = Cn(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new Ut(Mn(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var c = null;
    n.startAt && (c = On(n.startAt));
    var h = null;
    return n.endAt && (h = On(n.endAt)), function(t, e, n, r, i, o, s, u) {
        return new jt(t, e, n, r, i, o, s, u);
    }(e, i, u, s, a, "F" /* First */ , c, h);
}

function Cn(t) {
    return t ? void 0 !== t.unaryFilter ? [ xn(t) ] : void 0 !== t.fieldFilter ? [ Un(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Cn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : C() : [];
...
function Un(t) {
    return St.create(Mn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function xn(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = Mn(t.unaryFilter.field);
        return St.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Mn(t.unaryFilter.field);
        return St.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = Mn(t.unaryFilter.field);
        return St.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = Mn(t.unaryFilter.field);
 ...
 */ var Wn = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Ie(i, t, n[r]);
        }
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = Je(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
...
function Xn(t) {
    ...
    return "LAST" === t.limitType ? Jt(e, e.limit, "L" /* Last */) : e;
}
 ...
 */ var Jn = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), Kn.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Kn.resolve(this.Bt.getEntries(e));
    }, t;
}(), $n = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Ke(K.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Ke(K.comparator)).toArray();
    }, t;
}(), Zn = /** @class */ function() {
    function t(t) {
        this.Ht = t;
 ...
 */ var er = /** @class */ function() {
    ...
    function t() {
        ...
        this.changes = new er((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? Kn.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
 ...
 */
        ...
        var r = this, i = e.collectionGroup, o = Ye();
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Kt(e) || Qt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (N() <= c.DEBUG && S("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), te(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return N() <= c.DEBUG && S("QueryEngine", "Using full collection scan to execute query:", te(e)), 
    ...
    t, e, n, r) {
        ...
        this.qe = t.getTargetCache(), this.Mn = new ir(this.On, this._n, this.persistence.getIndexManager()), 
              ...
              case 0:
                return n = O(t), r = n._n, i = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        i = new ir(n.On, r, n.persistence.getIndexManager()), r.getAllMutationBatches(t);
                    })).next((function(e) {
 ...
 */ function cr(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = Kn.resolve();
 ...
 */ function lr(t, e) {
     ...
     */
        ...
        s.push(fr(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual(x.min())) {
        ...
        return Kn.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Mn.En(t, u);
        })).next((function() {
 ...
 */ function pr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.qe.getTargetData(t, e).next((function(i) {
            ...
            r = i, Kn.resolve(r)) : n.qe.allocateTargetId(t).next((function(i) {
                return r = new Hn(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.qe.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
 ...
 */ function vr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return void 0 !== i ? Kn.resolve(r.Fn.get(i)) : r.qe.getTargetData(e, n);
        }(r, t, Xt(e)).next((function(e) {
 ...
 */ function mr(t, e, n, r) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = O(t), o = Ze(), s = ze(), u = Je(), a = 0, c = n; a < c.length; a++) h = c[a], 
                ...
                return f = i.On.newChangeBuffer({
                    ...
                    return Xt(Gt(K.fromString("__bundle__/docs/" + t)));
                }(r)) ];
              ...
              case 1:
                ...
                return d = p.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return fr(t, f, s, x.min(), u).next((function(e) {
                        return f.apply(t), e;
                    })).next((function(e) {
 ...
 */ function gr(t, e, n) {
    return void 0 === n && (n = Ze()), w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , pr(t, Xt(Xn(e.bundledQuery))) ];
 ...
 */ var wr = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Kn.resolve(this.Kn.get(e));
    ...
    function t() {
        ...
        this.Wn = new Ke(_r.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new Ke(_r.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new it(new K([])), r = new _r(n, t), i = new _r(n, t + 1), o = [];
        ...
        var e = new it(new K([])), n = new _r(e, t), r = new _r(e, t + 1), i = Ze();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new _r(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    function t(t, e) {
        ...
        this.rs = new Ke(_r.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return Kn.resolve(0 === this._n.length);
        ...
        var o = new _r(new it(i), 0), s = new Ke(F);
    ...
    function t(t, e) {
        ...
        this.docs = new Be(it.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Kn.resolve(n ? n.document.clone() : _t.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = ze();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
        ...
        ; o.hasNext(); ) {
            ...
            h.compareTo(n) <= 0 || ee(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return Kn.resolve(r);
...
}(nr), Ar = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.ds = new er((function(t) {
            return It(t);
        }), At), 
        ...
        /**
             ...
             * IDs.
             */
        this._s = new br, this.targetCount = 0, this.ys = Zn.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Kn.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.ys.next(), Kn.resolve(this.highestTargetId);
        ...
        return this.te(e), this.targetCount += 1, Kn.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), Kn.resolve();
        ...
        return this._s.Jn(e, n), Kn.resolve();
        ...
        return this._s.Zn(e), Kn.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return Kn.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Kn.resolve(this._s.containsKey(e));
    }, t;
}(), Nr = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        ...
        this.qe = new Ar(this), this.Ut = new Jn, this.Ue = function(t, e) {
            return new Tr(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.Ut), this.R = new Yn(e), this.Qe = new wr(this.R);
    }
    return t.prototype.start = function() {
        ...
        return e || (e = new Er(this.Ut, this.referenceDelegate), this.gs[t.toKey()] = e), 
        e;
        ...
        return Kn.or(Object.values(this.gs).map((function(n) {
            return function() {
    ...
    return t.bs = function(e) {
        ...
        return this.As.addReference(n, e), this.vs.delete(n.toString()), Kn.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.vs.add(n.toString()), Kn.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.vs.add(e.toString()), Kn.resolve();
        ...
        // Remove newly orphaned documents.
                return Kn.forEach(this.vs, (function(r) {
            var i = it.fromPath(r);
        ...
        var n = this;
        return Kn.or([ function() {
            return Kn.resolve(n.As.containsKey(e));
        }, function() {
...
kr.GOOGLE_CREDENTIALS = new kr("google-credentials-uid"), kr.FIRST_PARTY = new kr("first-party-uid");
...
var Rr = /** @class */ function() {
    ...
    return g(u, s), u.prototype.ki = function(t, e, n, r) {
        ...
        var g = c.createWebChannel(f, l), w = !1, b = !1, _ = new Vr({
            Ei: function(t) {
 ...
 */ var xr = /** @class */ function() {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? T.UNKNOWN : qe(t.code);
                    return new I(e, t.message || "");
                }(u);
                n = new un(r, i, o, s || null);
            } else if ("documentChange" in e) {
                e.documentChange, (r = e.documentChange).document, r.document.name, r.document.updateTime, 
                i = En(t, r.document.name), o = gn(r.document.updateTime);
                var u = new wt({
                    mapValue: {
                        fields: r.document.fields
                    }
                }), a = (s = _t.newFoundDocument(i, o, u), r.targetIds || []), c = r.removedTargetIds || [];
                n = new on(a, c, s.key, s);
            } else if ("documentDelete" in e) e.documentDelete, (r = e.documentDelete).document, 
            i = En(t, r.document), o = r.readTime ? gn(r.readTime) : x.min(), u = _t.newNoDocument(i, o), 
            s = r.removedTargetIds || [], n = new on([], s, u.key, u); else if ("documentRemove" in e) e.documentRemove, 
            (r = e.documentRemove).document, i = En(t, r.document), o = r.removedTargetIds || [], 
            n = new on([], o, i, null); else {
                if (!("filter" in e)) return C();
                e.filter;
                var h = e.filter;
                h.targetId, r = h.count || 0, i = new Ue(r), o = h.targetId, n = new sn(o, i);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? x.min() : e.readTime ? gn(e.readTime) : x.min();
        }(t);
    ...
    e.prototype.mr = function(t) {
        var e = {};
        e.database = In(this.R), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = Nt(r) ? {
                documents: Dn(t, r)
            } : {
                query: kn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = vn(t, e.resumeToken) : e.snapshotVersion.compareTo(x.min()) > 0 && (
    ...
    e.prototype.yr = function(t) {
        var e = {};
        e.database = In(this.R), e.removeTarget = t, this.cr(e);
    }, e;
}(qr), jr = /** @class */ function(t) {
    function e(e, n, r, i, o) {
        var s = this;
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (L(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = gn(e)), new be(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
    ...
    e.prototype.Ar = function() {
        ...
        var t = {};
        t.database = In(this.R), this.cr(t);
    }, 
        ...
        n.enqueueAndForget((function() {
            return w(o, void 0, void 0, (function() {
                return b(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ti(this) ? (S("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return w(this, void 0, void 0, (function() {
                                var e;
                                return b(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = O(t)).Or.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , zr(e) ];
 ...
 */ function Yr(t, e) {
    var n = O(t), r = yi(n);
    n.$r.delete(e), r.er() && Jr(n, e), 0 === n.$r.size && (r.er() ? r.ir() : ti(n) && 
...
function Zr(t) {
    return ti(t) && !yi(t).tr() && t.$r.size > 0;
}
...
function ii(t, e, n) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(s) {
            switch (s.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof un && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof on ? t.qr.X(e) : e instanceof sn ? t.qr.rt(e) : t.qr.et(e), n.isEqual(x.min())) return [ 3 /*break*/ , 13 ];
                s.label = 7;

              case 7:
                return s.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , hr(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new Hn(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Xr(t, r);
                        }
              ...
              case 11:
                return S("RemoteStore", "Failed to raise snapshot:", o = s.sent()), [ 4 /*yield*/ , oi(t, o) ];
        ...
        return b(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.Or.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , zr(t) ];
...
function ui(t) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(s) {
            switch (s.label) {
              case 0:
                e = O(t), n = vi(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return s.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , dr(e.localStore, r) ];
              ...
              case 4:
                return o = s.sent(), [ 4 /*yield*/ , oi(e, o) ];
...
function ai(t) {
    return ti(t) && !vi(t).tr() && t.kr.length > 0;
}
...
function li(t) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            ...
            for (e = vi(t), n = 0, r = t.kr; n < r.length; n++) i = r[n], e.Er(i.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function fi(t, e, n) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            switch (o.label) {
              case 0:
                return r = t.kr.shift(), i = zn.from(r, e, n), [ 4 /*yield*/ , si(t, (function() {
...
function di(t, e) {
    return w(this, void 0, void 0, (function() {
        return b(this, (function(n) {
            switch (n.label) {
              case 0:
                return e && vi(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return w(this, void 0, void 0, (function() {
                        var n, r;
                        return b(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return xe(r = e.code) && r !== T.ABORTED ? (n = t.kr.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                vi(t).sr(), [ 4 /*yield*/ , si(t, (function() {
 ...
 */ function pi(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = O(t), e ? (n.Or.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Wr(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.Or.add(2 /* IsSecondary */), [ 4 /*yield*/ , zr(n) ]);
    ...
    t.Ur = function(t, e, n) {
        ...
        return w(e, void 0, void 0, (function() {
            return b(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), Zr(t) ? $r(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.Ur.stop() ];

                  case 2:
                    e.sent(), ei(t), e.label = 3;
    ...
    t.Qr = function(t, e, n) {
        ...
        return w(e, void 0, void 0, (function() {
            return b(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Qr.sr(), [ 4 /*yield*/ , ui(t) ]) : [ 3 /*break*/ , 2 ];
...
var mi = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new Gn, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
 ...
 */ function gi(t, e) {
    if (D("AsyncQueue", e + ": " + t), Qn(t)) return new I(T.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var wi = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = Ye(), this.sortedSet = new Be(this.comparator)
        /**
    ...
    this.queries = new er((function(t) {
        return Zt(t);
 ...
 */ function Ii(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = O(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Ei), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
              ...
              case 3:
                return u = c.sent(), a = gi(u, "Initialization of query '" + te(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(a) ];

              case 4:
                return n.queries.set(r, o), o.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), o.Wr && e.Hr(o.Wr) && Di(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var ki = /** @class */ function() {
    ...
    return t.prototype.Hr = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new _i(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = _i.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), Ri = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.Un = function(t) {
        return t.metadata.exists ? function(t, e, n) {
            var r = En(t, e.name), i = gn(e.updateTime), o = new wt({
                mapValue: {
                    fields: e.fields
                }
            }), s = _t.newFoundDocument(r, i, o);
            return n && s.setHasCommittedMutations(), n ? s.setHasCommittedMutations() : s;
        }(this.R, t.document, !1) : _t.newNoDocument(this.qn(t.metadata.name), this.Qn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Oi(t)
        /**
    ...
    return t.prototype.oo = function(t) {
        ...
        for (var e = new Map, n = new Ci(this.R), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
    ...
    t.prototype.complete = function() {
        return w(this, void 0, void 0, (function() {
            ...
            return b(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return [ 4 /*yield*/ , mr(this.localStore, new Ci(this.R), this.documents, this.ro.id) ];

                  case 1:
                    t = o.sent(), e = this.co(this.documents), n = 0, r = this.queries, o.label = 2;

                  case 2:
                    return n < r.length ? (i = r[n], [ 4 /*yield*/ , gr(this.localStore, i, e.get(i.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new rr(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Pi = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Ze(), this.lo = ne(t), this.fo = new wi(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new bi, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = Kt(this.query) && i.size === this.query.limit ? i.last() : null, c = Qt(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), l = ee(n.query, e) ? e : null, f = !!h && n.mutatedKeys.has(h.key), d = !!l && (l.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), Kt(this.query) || Qt(this.query)) for (;s.size > this.query.limit; ) {
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.ao = u, 0 !== o.length || a ? {
            snapshot: new _i(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.Ro = function() {
        return _i.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.ao);
    }, t;
}(), Mi = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.vo = {}, this.Po = new er((function(t) {
            return Zt(t);
        }), $t), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new Be(it.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new br, 
        ...
        return b(this, (function(a) {
            switch (a.label) {
              case 0:
                return n = function(t) {
                    var e = O(t);
                    return e.remoteStore.remoteSyncer.applyRemoteEvent = Ki.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = oo.bind(null, e), 
                    e.remoteStore.remoteSyncer.rejectListen = Wi.bind(null, e), e.vo._r = Ni.bind(null, e.eventManager), 
                    e.vo.Mo = Si.bind(null, e.eventManager), e;
                }(t), (o = n.Po.get(e)) ? (
              ...
              case 1:
                return [ 4 /*yield*/ , pr(n.localStore, Xt(e)) ];

              case 2:
                return s = a.sent(), u = n.sharedClientState.addLocalQueryTarget(s.targetId), r = s.targetId, 
                [ 4 /*yield*/ , Bi(n, e, r, "current" === u) ];

              case 3:
                i = a.sent(), n.isPrimaryClient && Hr(n.remoteStore, s), a.label = 4;
                    ...
                    return function(t, e, n, r) {
                        return w(this, void 0, void 0, (function() {
                            ...
                            return b(this, (function(u) {
                                switch (u.label) {
                                  case 0:
                                    return i = e.view._o(n), i.Nn ? [ 4 /*yield*/ , vr(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, o), [ 2 /*return*/ , (to(t, e.targetId, s.To), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, n, r);
                }, [ 4 /*yield*/ , vr(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = h.sent(), o = new Fi(e, i.Bn), s = o._o(i.documents), u = rn.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), to(t, n, a.To), c = new Mi(e, n, o), 
...
/** Stops listening to the query. */ function ji(t, e) {
    return w(this, void 0, void 0, (function() {
        var n, r, i;
        return b(this, (function(o) {
            switch (o.label) {
              case 0:
                ...
                n.sharedClientState.removeLocalQueryTarget(r.targetId), n.sharedClientState.isActiveQueryTarget(r.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , yr(n.localStore, r.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(r.targetId), Yr(n.remoteStore, r.targetId), 
                    $i(n, r.targetId);
                })).catch(tr) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return $i(n, r.targetId), [ 4 /*yield*/ , yr(n.localStore, r.targetId, 
        ...
        return b(this, (function(u) {
            switch (u.label) {
              case 0:
                r = function(t) {
                    var e = O(t);
                    return e.remoteStore.remoteSyncer.applySuccessfulWrite = zi.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Hi.bind(null, e), 
                    e
                    /**
 ...
 */;
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = Ne(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new Re(c.key, h, bt(h.value.mapValue), _e.exists(!0)));
                            }
              ...
              case 2:
                return i = u.sent(), r.sharedClientState.addPendingMutation(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new Be(F)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(r, i.batchId, n), [ 4 /*yield*/ , ro(r, i.changes) ];

              case 3:
                return u.sent(), [ 4 /*yield*/ , ui(r.remoteStore) ];

              case 4:
                return u.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return o = u.sent(), s = gi(o, "Failed to persist write"), n.reject(s), [ 3 /*break*/ , 6 ];
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(i) {
            switch (i.label) {
              ...
              case 1:
                return i.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , lr(n.localStore, e) ];
        ...
        return b(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new Be(it.comparator)).insert(o, _t.newNoDocument(o, x.min())), 
                u = Ze().add(o), a = new nn(x.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Ke(F), s, u), [ 4 /*yield*/ , Ki(r, a) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                r.Do = r.Do.remove(o), r.Co.delete(e), no(r), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , yr(r.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return $i(r, e, n);
                })).catch(tr) ];
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            switch (o.label) {
              ...
              case 1:
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , cr(n.localStore, e) ];
              ...
              case 2:
                ...
                Ji(n, r, /*error=*/ null), Xi(n, r), n.sharedClientState.updateMutationState(r, "acknowledged"), 
                [ 4 /*yield*/ , ro(n, i) ];
        ...
        return b(this, (function(o) {
            switch (o.label) {
              ...
              case 2:
                ...
                // listen events.
                Ji(r, e, n), Xi(r, e), r.sharedClientState.updateMutationState(e, "rejected", n), 
                [ 4 /*yield*/ , ro(r, i) ];
 ...
 */ function Yi(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(u) {
            switch (u.label) {
              case 0:
                ti((n = O(t)).remoteStore) || S("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
              ...
              case 3:
                return o = u.sent(), s = gi(o, "Initialization of waitForPendingWrites() operation failed"), 
...
function Zi(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && (Yr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), no(t));
}

function to(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Pi ? (t.No.addReference(o.key, e), eo(t, o)) : o instanceof Vi ? (S("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function no(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Ui(n)), t.Do = t.Do.insert(n, r), Hr(t.remoteStore, new Hn(Xt(Gt(n.path)), r, 2 /* LimboResolution */ , E.o));
    }
}
                              ...
                              case 1:
                                return l.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Kn.forEach(e, (function(e) {
                                        return Kn.forEach(e.bn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return Kn.forEach(e.vn, (function(r) {
        ...
        return b(this, (function(i) {
            switch (i.label) {
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, r.removedBatchIds, r.addedBatchIds), [ 4 /*yield*/ , ro(n, r.Ln) ];
        ...
        return w(this, void 0, void 0, (function() {
            ...
            return b(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Oi(r)), i = new Li(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = c.sent(), [ 4 /*yield*/ , ro(t, u.wn, 
                    /* remoteEvent */ void 0) ];
...
var uo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return w(this, void 0, void 0, (function() {
            return b(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Ur(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
        ...
        /** Manages our in-memory or durable persistence. */
        t, e, n, r) {
            return new ur(t, e, n, r);
        }(this.persistence, new sr, t.initialUser, this.R);
    }, t.prototype.qo = function(t) {
        return new Nr(Dr.bs, this.R);
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Qi(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = io.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , pi(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Ur(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Fr(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Qi(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Or.yt() ? new Or : new Lr, new Qr(e, n, r, i, o);
        ...
        return function(t) {
            return w(this, void 0, void 0, (function() {
                ...
                return b(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = O(t), S("RemoteStore", "RemoteStore shutting down."), e.Or.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , zr(e) ];
 ...
 */ var ho = /** @class */ function() {
        ...
        return w(this, void 0, void 0, (function() {
            ...
            return b(this, (function(i) {
                switch (i.label) {
                  ...
                  case 2:
                    return r = i.sent(), [ 2 /*return*/ , new Ri(JSON.parse(r), t.length + n) ];
                }
            }));
        }));
    }, 
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return w(this, void 0, void 0, (function() {
                            ...
                            return b(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = O(t), r = In(n.R) + "/documents", i = {
                                    ...
                                    return o = a.sent(), s = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = En(t, e.found.name), r = gn(e.found.updateTime), i = new wt({
                                                    mapValue: {
                                                ...
                                                var n = En(t, e.missing), r = gn(e.readTime);
    ...
    return t.prototype.run = function() {
        ...
        this.Zi.ji((function() {
            return w(t, void 0, void 0, (function() {
                var t, e, n = this;
                return b(this, (function(r) {
                    return t = new fo(this.datastore), (e = this.sc(t)) && e.then((function(e) {
    ...
    e, n) {
        var r = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = kr.UNAUTHENTICATED, 
            ...
            return w(t, void 0, void 0, (function() {
                ...
                return b(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = gi(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return o.sent(), r = n.initialUser, t.setCredentialChangeListener((function(t) {
                    return w(i, void 0, void 0, (function() {
                        return b(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return r.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , ar(e.localStore, t) ];
...
function mo(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(i) {
            switch (i.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , go(t) ];
                            ...
                            return b(this, (function(i) {
                                switch (i.label) {
                                  case 0:
                                    ...
                                    n.Or.add(3 /* CredentialChange */), [ 4 /*yield*/ , zr(n) ];
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = qi.bind(null, e.syncEngine), 
                n.onUnlisten = ji.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Ao(t, e, n) {
    var r = this;
    void 0 === n && (n = {});
    var i = new Gn;
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = kr.UNAUTHENTICATED, 
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (L("string" == typeof n.accessToken), new Ro(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.hc = function() {
        ...
        return L(null === t || "string" == typeof t), new kr(t);
    }, 
    /**
    ...
    function t(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = kr.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Po(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((function() {
            return e(kr.FIRST_PARTY);
        }));
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Bo(t) {
 ...
 */ var Ko = /** @class */ function() {
    function t(t) {
        ...
        Uo("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ko({}), 
        this._settingsFrozen = !1, t instanceof Do ? (this._databaseId = t, this._credentials = new Co) : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new Do(t.options.projectId);
        }(t), this._credentials = new Oo(e));
    }
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new Ko(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new Co;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = ko.get(t)) && (S("ComponentProvider", "Removing Datastore"), 
        ko.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}(), Wo = /** @class */ function() {
    /** @hideconstructor */
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new Ho(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, Gt(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function Yo(t, e) {
    ...
    if (t = s(t), Fo("collection", "path", e), t instanceof Qo) return qo(n = K.fromString.apply(K, _([ e ], r))), 
    new Ho(t, /* converter= */ null, n);
    if (!(t instanceof Wo || t instanceof Ho)) throw new I(T.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return qo(n = K.fromString.apply(K, _([ t.path ], r)).child(K.fromString(e))), new Ho(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Xo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = V.u()), Fo("doc", "path", e), t instanceof Qo) return xo(n = K.fromString.apply(K, _([ e ], r))), 
    new Wo(t, 
    /* converter= */ null, new it(n));
    if (!(t instanceof Wo || t instanceof Ho)) throw new I(T.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return xo(n = t._path.child(K.fromString.apply(K, _([ e ], r)))), new Wo(t.firestore, t instanceof Ho ? t.converter : null, new it(n));
}
 ...
 * Firestore database.
 */ function Jo(t, e) {
    return t = s(t), e = s(e), (t instanceof Wo || t instanceof Ho) && (e instanceof Wo || e instanceof Ho) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
var es = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new Gn, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
    ...
    return g(e, t), e.prototype._terminate = function() {
        ...
        os(this), this._firestoreClient.terminate();
    }, e;
}(Qo);
 ...
 */
function is(t) {
    return t._firestoreClient || os(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function os(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new So(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new yo(t._credentials, t._queue, r);
}
...
}(), hs = /^__.*__$/, ls = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Re(t, this.data, this.fieldMask, e, this.fieldTransforms) : new ke(t, this.data, e, this.fieldTransforms);
    }, t;
}(), fs = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var ps = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Fc = function(e) {
        ...
        return Ps(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Uc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ds(this.xc) && hs.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }, t;
}(), ys = /** @class */ function() {
    function t(t, e, n) {
 ...
 * classes.
 */ function vs(t) {
    var e = t._freezeSettings(), n = Ur(t._databaseId);
    return new ys(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function ms(t, e, n, r, i, o) {
    void 0 === o && (o = {});
...
}(as), Ts = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e) || this).jc = n, r;
    }
    return g(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new ve(t.R, se(t.R, this.jc));
...
/** Parse update data from an update() call. */ function Is(t, e, n, r) {
    ...
    var a = new z(o);
    return new fs(u, a, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function As(t, e, n, r, i, o) {
    var u = t.Qc(1 /* Update */ , e, n), a = [ Cs(e, r, n) ], c = [ i ];
    ...
    for (var h = 0; h < o.length; h += 2) a.push(Cs(e, o[h])), c.push(o[h + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], f = wt.empty(), d = a.length - 1; d >= 0; --d) if (!Vs(l, a[d])) {
        var p = a[d], y = c[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = s(y);
    ...
    var g = new z(l);
    return new fs(f, g, u.fieldTransforms);
}
 ...
 */ function Ns(t, e, n, r) {
    return void 0 === r && (r = !1), Ss(n, t.Qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ss(t, e) {
    ...
    // from firestore-exp.
    t = s(t))) return Rs("Unsupported field value:", e, t), Ds(t, e);
    if (t instanceof as) 
    ...
    return function(t, e) {
        ...
        if (!ds(e.xc)) throw e.Bc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Bc("Unsupported field value: " + Bo(t));
    }(t, e);
}
...
function ks(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof U || t instanceof cs || t instanceof us || t instanceof Wo || t instanceof as);
}
 ...
 */ function Cs(t, e, n) {
    ...
    // FieldPath.
    (e = s(e)) instanceof ss) return e._internalPath;
 ...
 * evaluated.
 */ function Os(t, e, n) {
    if (e.search(Ls) >= 0) throw Ps("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (ss.bind.apply(ss, _([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
 ...
 */ var Fs = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new Ms(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(Us("DocumentSnapshot.get", t));
 ...
 */
function Us(t, e) {
    return "string" == typeof e ? Os(t, e) : e instanceof ss ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var xs = /** @class */ function() {
    ...
    e.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new Bs(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    e.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(Us("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, e;
}(Fs), Bs = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Bs(n._firestore, n._userDataWriter, r.key, r, new xs(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new Bs(t._firestore, t._userDataWriter, e.doc.key, e.doc, new xs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Bs(t._firestore, t._userDataWriter, e.doc.key, e.doc, new xs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function Qs(t) {
    if (Qt(t) && 0 === t.explicitOrderBy.length) throw new I(T.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Hs = /** @class */ function(t) {
    ...
    return g(e, t), e.prototype._apply = function(t) {
        var e = vs(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || eu(s, o), 
            u = Ns(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = St.create(i, o, u);
            return function(t, e) {
                if (e.g()) {
                    var n = zt(t);
 ...
 */
    ...
    return g(e, t), e.prototype._apply = function(t) {
        return new zo(t.firestore, t.converter, Jt(t._query, this.Jc, this.Yc));
    }, e;
    ...
    return g(e, t), e.prototype._apply = function(t) {
        var e = Zs(t, this.type, this.Xc, this.Zc);
        return new zo(t.firestore, t.converter, function(t, e) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!Ht(t) && -1 !== c.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function tu(t, e, n) {
    if ("string" == typeof (n = s(n))) {
        ...
        if (!Ht(e) && -1 !== n.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    if (n instanceof Wo) return ft(t, n._key);
    throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Bo(n) + ".");
}
 ...
 */ var ru = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new cs(J(t.latitude), J(t.longitude));
        ...
        L(Bn(n));
        var r = new Do(n.get(1), n.get(3)), i = new it(n.popFirst(5));
        return r.isEqual(e) || 
...
var ou = /** @class */ function(t) {
...
}(ru), su = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = vs(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = uu(t, this._firestore), i = iu(r.converter, e, n), o = ms(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, _e.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = uu(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = s(e)) || e instanceof ss ? As(this._dataReader, "WriteBatch.update", u._key, e, n, r) : Is(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, _e.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = uu(t, this._firestore);
        return this._mutations = this._mutations.concat(new Fe(e._key, _e.none())), this;
    }, 
    /**
 ...
 */ function cu(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = jo(t, Wo);
    var o = jo(t.firestore, rs), u = vs(o);
    return lu(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = s(e)) || e instanceof ss ? As(u, "updateDoc", t._key, e, n, r) : Is(u, "updateDoc", t._key, e)).toMutation(t._key, _e.exists(!0)) ]);
}
 ...
 */ function hu(t) {
    ...
    "object" != typeof i[a] || ts(i[a]) || (u = i[a], a++);
    var c, h, l, f = {
    ...
    if (t instanceof Wo) h = jo(t.firestore, rs), l = Gt(t._key.path), c = {
        next: function(e) {
            i[a] && i[a](fu(h, t, e));
        },
        error: i[a + 1],
        ...
        var p = jo(t, zo);
        h = jo(p.firestore, rs), l = p._query;
        var y = new au(h);
        c = {
            next: function(t) {
                i[a] && i[a](new js(h, y, p, t));
            },
            error: i[a + 1],
            complete: i[a + 2]
        }, Qs(t._query);
    ...
    return function(t, e, n, r) {
        var i = this, o = new ho(r), s = new ki(e, o, n);
        return t.asyncQueue.enqueueAndForget((function() {
            return w(i, void 0, void 0, (function() {
                var e;
                return b(this, (function(n) {
 ...
 */ function fu(t, e, n) {
    var r = n.docs.get(e._key), i = new au(t);
    return new qs(t, i, e._key, r, new xs(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var du = /** @class */ function(t) {
     ...
     */    return g(e, t), e.prototype.get = function(e) {
        var n = this, r = uu(e, this._firestore), i = new au(this._firestore);
        return t.prototype.get.call(this, e).then((function(t) {
            return new qs(n._firestore, i, r._key, t._document, new xs(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = vs(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = uu(t, this._firestore), r = new ou(this._firestore);
        ...
        var r = uu(t, this._firestore), i = iu(r.converter, e, n), o = ms(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = s(e)) || e instanceof ss ? As(this._dataReader, "Transaction.update", u._key, e, n, r) : Is(this._dataReader, "Transaction.update", u._key, e), 
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function pu() {
    if ("undefined" == typeof Uint8Array) throw new I(T.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function yu() {
    if ("undefined" == typeof atob) throw new I(T.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}

/** Immutable class holding a blob (binary data) */ var vu = /** @class */ function() {
    function t(t) {
        this._delegate = t;
    }
    return t.fromBase64String = function(e) {
        return yu(), new t(us.fromBase64String(e));
    }, t.fromUint8Array = function(e) {
        return pu(), new t(us.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return yu(), this._delegate.toBase64();
    }, t.prototype.toUint8Array = function() {
        return pu(), this._delegate.toUint8Array();
    }, t.prototype.isEqual = function(t) {
        return this._delegate.isEqual(t._delegate);
    }, t.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, t;
}(), mu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", gu = /** @class */ function() {
    function t() {}
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        throw new I(T.FAILED_PRECONDITION, mu);
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        t.merge || e.host === t.host || k("You are overriding the original host. If you did not intend to override your settings, use {merge: true}."), 
        t.merge && 
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                t._credentials = new Lo(new Ro(o, new kr(s)));
            }
        ...
        /** Disables the network connection. Pending operations will not complete. */ (is(jo(this._delegate, rs)));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                                return w(this, void 0, void 0, (function() {
                                    ...
                                    return b(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = O(t)).Or.add(0 /* UserDisabled */), [ 4 /*yield*/ , zr(e) ];
 ...
 */ (is(jo(this._delegate, rs)));
    }, t.prototype.enablePersistence = function(t) {
        var e = !1, n = !1;
        return t && Uo("synchronizeTabs", e = !!t.synchronizeTabs, "experimentalForceOwningTab", n = !!t.experimentalForceOwningTab), 
 ...
 */;
        ...
        try {
            return new Pu(this, Yo(this._delegate, t));
        } catch (t) {
            throw Nu(t, "collection()", "Firestore.collection()");
        }
    }, t.prototype.doc = function(t) {
        try {
            return new Au(this, Xo(this._delegate, t));
        } catch (t) {
            throw Nu(t, "doc()", "Firestore.doc()");
        }
    }, t.prototype.collectionGroup = function(t) {
        try {
            return new Cu(this, function(t, e) {
                if (t = jo(t, Qo), Fo("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new I(T.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new zo(t, 
                /* converter= */ null, 
                /**
 ...
 */
                function(t) {
                    return new jt(K.emptyPath(), t);
                }(e));
            }(this._delegate, t));
        } catch (t) {
            throw Nu(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
                    ...
                    return w(n, void 0, void 0, (function() {
                        ...
                        return b(this, (function(i) {
                            switch (i.label) {
                              ...
                              case 1:
                                return n = i.sent(), new po(t.asyncQueue, n, e, r).run(), [ 2 /*return*/ ];
                            }
                        }));
                    }));
                })), r.promise;
        ...
        var t = this;
        return is(this._delegate), new Tu(new su(this._delegate, (function(e) {
            return lu(t._delegate, e);
        })));
    ...
    return g(e, t), e.prototype.convertBytes = function(t) {
        return new vu(new us(t));
    }, e.prototype.convertReference = function(t) {
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Au.nu(e, this.firestore, /* converter= */ null);
    }, e;
}(ru);
 ...
 */ var Eu = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        return this._delegate.get(n).then((function(t) {
            return new ku(e._firestore, new qs(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Vu(t);
        return n ? (Mo("Transaction.set", n), this._delegate.set(r, e, n)) : this._delegate.set(r, e), 
        this;
    }, t.prototype.update = function(t, e, n) {
    ...
    return t.prototype.set = function(t, e, n) {
        var r = Vu(t);
        return n ? (Mo("WriteBatch.set", n), this._delegate.set(r, e, n)) : this._delegate.set(r, e), 
        this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i = [], o = 3; o < arguments.length; o++) i[o - 3] = arguments[o];
        var s = Vu(t);
    ...
    return t.prototype.fromFirestore = function(t, e) {
        var n = new Bs(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, 
        /* converter= */ null);
        return this._delegate.fromFirestore(new Ru(this._firestore, n), null != e ? e : {});
    ...
    t.su = function(e, n) {
        ...
        var o = i.get(n);
        return o || (o = new t(e, new bu(e), n), i.set(n, o)), o;
    }, t;
}();
...
var Au = /** @class */ function() {
    ...
    return t.ru = function(e, n, r) {
        ...
        return new t(n, new Wo(n._delegate, r, new it(e)));
    }, t.nu = function(e, n, r) {
        ...
        try {
            return new Pu(this.firestore, Yo(this._delegate, t));
        } catch (t) {
            throw Nu(t, "collection()", "DocumentReference.collection()");
        }
    }, t.prototype.isEqual = function(t) {
        return (t = s(t)) instanceof Wo && Jo(this._delegate, t);
    }, t.prototype.set = function(t, e) {
        e = Mo("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = jo(t, Wo);
                var r = jo(t.firestore, rs), i = iu(t.converter, e, n);
                return lu(r, [ ms(vs(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, _e.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
            throw Nu(t, "setDoc()", "DocumentReference.set()");
        }
    }, t.prototype.update = function(t, e) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        try {
            return 1 === arguments.length ? cu(this._delegate, t) : cu.apply(void 0, _([ this._delegate, t, e ], n));
        } catch (t) {
            throw Nu(t, "updateDoc()", "DocumentReference.update()");
        }
    }, t.prototype.delete = function() {
        return lu(jo((t = this._delegate).firestore, rs), [ new Fe(t._key, _e.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = Su(e), i = Du(e, (function(e) {
            return new ku(t.firestore, new qs(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        return hu(this._delegate, r, i);
    }, t.prototype.get = function(t) {
        var e = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = jo(t, Wo);
            var e = jo(t.firestore, rs), n = is(e), r = new au(e);
            return function(t, e) {
                var n = this, r = new Gn;
                return t.asyncQueue.enqueueAndForget((function() {
                    return w(n, void 0, void 0, (function() {
                                    ...
                                    return w(this, void 0, void 0, (function() {
                                        ...
                                        return b(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 2:
                                                return r = o.sent(), i = gi(r, "Failed to get document '" + e + " from cache"), 
                ...
                return new qs(e, r, t._key, n, new xs(null !== n && n.hasLocalMutations, 
                /* fromCache= */ !0), t.converter);
            }));
        }(this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = jo(t, Wo);
            var e = jo(t.firestore, rs);
            return Ao(is(e), t._key, {
                source: "server"
            }).then((function(n) {
                return fu(e, t, n);
            }));
            ...
            t = jo(t, Wo);
            var e = jo(t.firestore, rs);
            return Ao(is(e), t._key).then((function(n) {
                return fu(e, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new ku(e.firestore, new qs(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Iu.su(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
function Su(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !ts(r)) return r;
    }
    return {};
}
 ...
 */ function Du(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = ts(t[0]) ? t[0] : ts(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var ku = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "ref", {
        get: function() {
            return new Au(this._firestore, this._delegate.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "id", {
        ...
        return Ks(this._delegate, t._delegate);
    }, t;
}(), Ru = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    ...
    return t.prototype.where = function(e, n, r) {
        try {
            ...
            return new t(this.firestore, zs(this._delegate, function(t, e, n) {
                var r = e, i = Us("where", t);
                return new Hs(i, r, n);
            }(e, n, r)));
        } catch (e) {
            throw Nu(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            return new t(this.firestore, zs(this._delegate, function(t) {
                return Go("limit", t), new Xs("limit", t, "F" /* First */);
            }(e)));
        } catch (e) {
            throw Nu(e, "limit()", "Query.limit()");
        }
    }, t.prototype.limitToLast = function(e) {
        try {
            return new t(this.firestore, zs(this._delegate, function(t) {
                return Go("limitToLast", t), new Xs("limitToLast", t, "L" /* Last */);
            }(e)));
        } catch (e) {
            throw Nu(e, "limitToLast()", "Query.limitToLast()");
        }
        ...
        try {
            return new t(this.firestore, zs(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Js("startAt", t, /*before=*/ !0);
            }.apply(void 0, e)));
        } catch (e) {
            throw Nu(e, "startAt()", "Query.startAt()");
        }
        ...
        try {
            return new t(this.firestore, zs(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Js("startAfter", t, 
                /*before=*/ !1);
            }.apply(void 0, e)));
        } catch (e) {
            throw Nu(e, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            ...
            throw Nu(e, "endBefore()", "Query.endBefore()");
        }
     ...
     */
        function(t) {
            ...
            return function(t, e) {
                                ...
                                return n = function(t, e, n) {
                                    return w(this, void 0, void 0, (function() {
                                        ...
                                        return b(this, (function(a) {
                                            switch (a.label) {
                                              case 0:
                                                return a.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , vr(t, e, 
                                                /* usePreviousResults= */ !0) ];
                                              ...
                                              case 2:
                                                return s = a.sent(), u = gi(s, "Failed to execute query '" + e + " against cache"), 
                ...
                return new js(e, r, t, n);
            }));
        }(this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = jo(t, zo);
            var e = jo(t.firestore, rs), n = is(e), r = new au(e);
            return No(n, t._query, {
                source: "server"
            }).then((function(n) {
                return new js(e, r, t, n);
            }));
            ...
            t = jo(t, zo);
            var e = jo(t.firestore, rs), n = is(e), r = new au(e);
            return Qs(t._query), No(n, t._query).then((function(n) {
                return new js(e, r, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new Ou(e.firestore, new js(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Su(e), i = Du(e, (function(e) {
            return new Ou(t.firestore, new js(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return hu(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Iu.su(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(t.prototype, "type", {
        ...
        get: function() {
            return new Ru(this._firestore, this._delegate.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Cu(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "metadata", {
        ...
        return this._delegate.docChanges(t).map((function(t) {
            return new Lu(e._firestore, t);
        }));
    }, t.prototype.forEach = function(t, e) {
        var n = this;
        this._delegate.forEach((function(r) {
            t.call(e, new Ru(n._firestore, r));
        }));
    }, t.prototype.isEqual = function(t) {
        return Ks(this._delegate, t._delegate);
    }, t;
    ...
    return g(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        try {
            return new Au(this.firestore, void 0 === t ? Xo(this._delegate) : Xo(this._delegate, t));
        } catch (t) {
            throw Nu(t, "doc()", "CollectionReference.doc()");
        }
    }, e.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = jo(t.firestore, rs), r = Xo(t), i = iu(t.converter, e);
            return lu(n, [ ms(vs(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, _e.exists(!1)) ]).then((function() {
                return r;
            }));
        }(this._delegate, t).then((function(t) {
            return new Au(e.firestore, t);
        }));
    }, e.prototype.isEqual = function(t) {
        return Jo(this._delegate, t._delegate);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, t ? this._delegate.withConverter(Iu.su(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Cu);
 ...
 */ var Fu = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        this._delegate = new (ss.bind.apply(ss, _([ void 0 ], t)));
    }
    return t.documentId = function() {
        ...
        return (t = s(t)) instanceof ss && this._delegate._internalPath.isEqual(t._internalPath);
    }, t;
}(), Mu = /** @class */ function() {
    function t(t) {
        this._delegate = t;
 ...
 */
    return function(t, e) {
        var n = is(t = jo(t, rs)), r = new es;
        return function(t, e, n, r) {
            var i = this, o = function(t, e) {
                return function(t, e) {
                    return new lo(t, e);
                }(function(t, e) {
                    if (t instanceof Uint8Array) return co(t, e);
                    if (t instanceof ArrayBuffer) return co(new Uint8Array(t), e);
...
function xu(t) {
    ...
    }(is(e = jo(e, rs)), n).then((function(t) {
        return t ? new zo(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Cu(r, t) : null;
    }));
}

export { U as $, wu as B, ku as J, Tu as K, gu as M, Eu as Q, cs as S, _u as U, Au as W, Cu as X, Ru as Y, vu as a, Pu as e, ns as g, Mu as i, xu as o, rs as p, Uu as r, Fu as s, Ou as t };
//# sourceMappingURL=prebuilt-714a6fc9-09a2bf56.js.map
