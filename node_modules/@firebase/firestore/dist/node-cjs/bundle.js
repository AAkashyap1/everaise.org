...
function loadBundle(data) {
    return database6d433f85.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database6d433f85.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database6d433f85.Query$1(_this, 
...
registerBundle(database6d433f85.Firestore);
