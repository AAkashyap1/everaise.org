 ...
 */ class Rs {
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static yt() {
        ...
        // Check the UA string to find out the browser.
                const e = getUA(), n = Rs._t(e), s = 0 < n && n < 10, i = Rs.Et(e), r = 0 < i && i < 4.5;
        // IE 10
...
function hu(t, e, ...n) {
    if (t = getModularInstance(t), Yc("collection", "path", e), t instanceof ou) {
 ...
 * Firestore database.
 */ function du(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), (t instanceof cu || t instanceof au) && (e instanceof cu || e instanceof au) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function wu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof uu && e instanceof uu && (t.firestore === e.firestore && te(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function Gu(t, e) {
    ...
    // from firestore-exp.
    t = getModularInstance(t))) return Ju("Unsupported field value:", e, t), zu(t, e);
    if (t instanceof Vu) 
...
function pa(t, e, n, s) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof na) return function(t, e, n, s, i) {
 ...
 */ class va {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof vu ? ju(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Ku(this._dataReader, "WriteBatch.update", i._key, e), 
 ...
 */ function Sa(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof vu ? ju(r, "updateDoc", t._key, e, n, s) : Ku(r, "updateDoc", t._key, e);
 ...
 */ class xa extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof vu ? ju(this._dataReader, "Transaction.update", i._key, e, n, s) : Ku(this._dataReader, "Transaction.update", i._key, e), 
...
class Wa {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof cu && du(this._delegate, t);
    }
    set(t, e) {
...
export { $, Ba as B, Ja as J, Ka as K, La as L, Qa as Q, Su as S, Ua as U, Wa as W, Xa as X, Ya as Y, $a as a, eh as e, gu as g, ih as i, oh as o, pu as p, rh as r, sh as s, th as t };
//# sourceMappingURL=prebuilt-017a5aaf.js.map
