...
/** Creates a deep copy of `source`. */ function Vt(t) {
    ...
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, rt(t.timestampValue))
    };
    if (t.mapValue) {
        const e = {
            mapValue: {
 ...
 */ class Ct {
     ...
     */    static newInvalidDocument(t) {
        return new Ct(t, 0 /* INVALID */ , G.min(), St.empty(), 0 /* SYNCED */);
    }
    /**
...
class Mt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new Bt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Qt(t, n) : "in" /* IN */ === e ? new jt(t, n) : "not-in" /* NOT_IN */ === e ? new Wt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Gt(t, n) : new Mt(t, e, n);
    }
    static l(t, e, n) {
...
/** A Filter that implements the IN operator. */ class jt extends Mt {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
 ...
 */ function ue(t) {
    ...
    if (null === e.p) {
        ...
        t.isKeyField() || e.p.push(new Jt(t)), e.p.push(new Jt(tt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ (t, e, n) : t instanceof Qe ? function(t, e, n) {
        ...
        i.setAll(je(t)), i.setAll(s), e.convertToFoundDocument(qe(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ class gn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, yn.createSynthesizedTargetChangeForCurrentChange(t, e)), new gn(G.min(), n, mn(), un(), wn());
    }
}
...
class An {
     ...
     */    rt(t) {
        ...
        if (s) {
            ...
            if (Ft(t)) if (0 === n) {
                ...
                this.tt(e, n, Ct.newNoDocument(n, G.min()));
            } else L(1 === n); else {
                this.ct(e) !== n && (
     ...
     */    ut(t) {
        ...
        return this.H = un(), this.J = Rn(), this.Y = new rn(K), s;
    }
    /**
    ...
    ht(t) {
        let e = this.J.get(t);
        return e || (e = new rn(K), this.J = this.J.insert(t, e)), e;
    }
    /**
...
function Mn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? X.emptyPath() : Bn(e);
}
...
function Qn(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            const e = void 0 === t.code ? S.UNKNOWN : tn(t.code);
 ...
 */ (o);
        ...
        s.document;
        const i = On(t, s.document), r = s.readTime ? Nn(s.readTime) : G.min(), o = Ct.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new pn([], c, o.key, o);
...
function Wn(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        let n = null;
        if ("setToServerValue" in e) L("REQUEST_TIME" === e.setToServerValue), n = new Re; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Pe(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new ve(t);
        } else "increment" in e ? n = new Se(t, e.increment) : M();
...
function Xn(t) {
    return t ? void 0 !== t.unaryFilter ? [ os(t) ] : void 0 !== t.fieldFilter ? [ rs(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Xn(t))).reduce(((t, e) => t.concat(e))) : M() : [];
}
 ...
 */ class xs {
    ...
    next(t, e) {
        return this.callbackAttached && M(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new xs(((n, s) => {
            this.nextCallback = e => {
 ...
 */ class $s {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === $s._t(h()) && $("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return k("SimpleDb", "Removing database:", t), Bs(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = h(), e = $s._t(t), n = 0 < e && e < 10, s = $s.Et(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async At(t) {
        return this.db || (k("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new D(S.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Fs(t, s));
            }, s.onupgradeneeded = t => {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Fs extends D {
    constructor(t, e) {
...
function ei(t, e) {
    ...
    const s = e.mutations.map((e => Wn(t.Lt, e))), i = W.fromMillis(e.localWriteTimeMs);
    return new js(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function ni(t) {
    const e = ti(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? ti(t.lastLimboFreeSnapshotVersion) : G.min();
    let s;
    var i;
 ...
 */ class ai {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new rn(X.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new rn(X.comparator)).toArray();
    }
}
...
class mi {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            let h = new rn(((t, e) => K(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
    ...
    lookupMutationBatch(t, e) {
        return yi(t).get(e).next((t => t ? (L(t.userId === this.userId), ei(this.R, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return yi(t).Ot({
            ...
            e.userId === this.userId && (L(e.batchId >= n), i = ei(this.R, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return pi(t).Ot({
            ...
            return yi(t).get(u).next((t => {
                if (!t) throw M();
                L(t.userId === this.userId), i.push(ei(this.R, t));
            }));
            r.done();
        })).next((() => i));
    }
    ...
    Wt(t, e) {
        ...
        return e.forEach((e => {
            s.push(yi(t).get(e).next((t => {
                if (null === t) throw M();
                L(t.userId === this.userId), n.push(ei(this.R, t));
            })));
        })), xs.waitFor(s).next((() => n));
    }
 ...
 */
function yi(t) {
    return Qs(t, ms.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function pi(t) {
    return Qs(t, gs.store);
}
 ...
 */ class Ii {
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Ai(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (L(e.targetCount > 0), 
    ...
    Xt(t) {
        return Ri(t).get(Rs.key).next((t => (L(null !== t), t)));
    }
    Zt(t, e) {
 ...
 */ async function bi(t) {
    if (t.code !== S.FAILED_PRECONDITION || t.message !== Ds) throw t;
    ...
    ue(t) {
        ...
        k("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Ms(t) ? k("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await bi(t);
            }
            await this.ue(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Di {
    ...
    collect(t, e) {
        ...
        xs.resolve(fi)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (k("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        fi) : this.fe(t, e)));
    }
    getCacheSize(t) {
 ...
 */ class $i {
    ...
    getMetadata(t) {
        return Fi(t).get(Ts.key).next((t => (L(!!t), t)));
    }
    me(t, e) {
...
class Oi extends ki {
    ...
    applyChanges(t) {
        const e = [];
        let n = 0, s = new rn(((t, e) => K(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            ...
            if (r.document.isValidDocument()) {
                ...
                const n = Js(this.Ie.R, Ct.newNoDocument(i, G.min()), this.getReadTime(i));
...
class Ki {
    ...
    a) {
        ...
        this.Me = t => Promise.resolve(), !Ki.gt()) throw new D(S.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
        ...
        (this.R, this.qt), this.Ke = new ri, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
     ...
     */    start() {
        ...
        return this.je().then((() => {
            ...
            throw new D(S.FAILED_PRECONDITION, qi);
     ...
     * primary lease.
     */    je() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => ji(t).put(new bs(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    Je(t) {
        return Qi(t).get(ws.key).next((t => xs.resolve(this.tn(t))));
    }
    en(t) {
    ...
    getMutationQueue(t) {
        return mi.Qt(t, this.R, this.qt, this.referenceDelegate);
    }
    getTargetCache() {
        return this.Ue;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Ss, (s => (i = new Ks(s, this.Ne ? this.Ne.next() : V.o), 
        "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
            ...
            this.Se.enqueueRetryable((() => this.Me(!1))), new D(S.FAILED_PRECONDITION, Ds);
            return n(i);
    ...
    // be turned off.
    dn(t) {
        return Qi(t).get(ws.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new D(S.FAILED_PRECONDITION, qi);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
        const e = Qi(t);
        return e.get(ws.key).next((t => this.tn(t) ? (k("IndexedDbPersistence", "Releasing primary lease."), 
 ...
 */ class Ji {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (se(e) || ie(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (N() <= u.DEBUG && k("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), de(e)), 
    ...
    Dn(t, e) {
        return N() <= u.DEBUG && k("QueryEngine", "Using full collection scan to execute query:", de(e)), 
 ...
 */ function cr(t, e, n) {
    ...
    })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : G.min(), n ? r : wn()))).next((t => ({
        documents: t,
        Bn: r
    })))));
}
...
async function lr(t, e, n, s) {
    ...
    const u = i.Fn.newChangeBuffer({
        ...
        return ae(ne(X.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => sr(t, u, o, G.min(), c).next((e => (u.apply(t), 
...
async function fr(t, e, n = wn()) {
    ...
    const s = await rr(t, ae(ii(e.bundledQuery))), i = B(t);
 ...
 */ class wr {
     ...
     * removed.
     */    Zn(t) {
        const e = new wt(new X([])), n = new _r(e, t), s = new _r(e, t + 1), i = [];
    ...
    es(t) {
        const e = new wt(new X([])), n = new _r(e, t), s = new _r(e, t + 1);
        let i = wn();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
...
class vr {
     ...
     */    static Vs(t, e, n) {
        ...
        r && (i = new D(s.error.code, s.error.message))), r ? new vr(t, e, s.state, i) : ($("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Ss() {
        const t = {
 ...
 */ class Sr {
     ...
     */    static Vs(t, e) {
        ...
        return s ? new Sr(t, i) : ($("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Dr {
     ...
     */    static Vs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Dr(e.clientId, e.onlineState) : ($("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Nr {
    constructor(t, e, n, s, i) {
        ...
        this.$s = new en(K), this.started = !1, 
        /**
 ...
 */ class Qr extends Kr {
    ...
    onMessage(t) {
        ...
        const e = Qn(this.R, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? G.min() : e.readTime ? Nn(e.readTime) : G.min();
        }(t);
     ...
     */    mr(t) {
        ...
        e.database = Ln(this.R), e.addTarget = function(t, e) {
            ...
            return n = Ft(s) ? {
                ...
                query: Hn(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Dn(t, e.resumeToken) : e.snapshotVersion.compareTo(G.min()) > 0 && (
    ...
    e, n, s, i) {
        ...
        this.Mr = [], this.Lr = i, this.Lr.di((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                so(this) && (k("RemoteStore", "Restarting streams for network reachability change."), 
 ...
 */
        ...
        k("RemoteStore", "Failed to raise snapshot:", e), await uo(t, e);
    }
}
 ...
 */ function Io(t) {
    ...
    t.Kr = function(t, e, n) {
        ...
        await ho(t)) : (await t.Kr.stop(), t.$r.length > 0 && (k("RemoteStore", `Stopping write stream with ${t.$r.length} pending writes`), 
        t.$r = []));
    }))), t.Kr;
}
 ...
 */ async function Ho(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = B(t), s = W.now(), i = e.reduce(((t, e) => t.add(e.key)), wn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new Qe(t.key, e, Dt(e.value.mapValue), $e.exists(!0)));
                }
 ...
 */ async function Xo(t, e, n) {
    ...
    if (r) {
        ...
        t = t.insert(r, Ct.newNoDocument(r, G.min()));
        const n = wn().add(r), i = new gn(G.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new rn(K), t, n);
        await Jo(s, i), 
 ...
 */ async function ec(t, e) {
    const n = B(t);
    so(n.remoteStore) || k("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
 ...
 */ function uc(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(s, new Qo(n)), t.Do = t.Do.insert(n, s), Yr(t.remoteStore, new Gs(ae(ne(n.path)), s, 2 /* LimboResolution */ , V.o));
    }
}
 ...
 */ async function fc(t, e) {
    const n = B(t), s = await cr(n.localStore, e.query, 
...
async function wc(t, e, n, s) {
    const i = B(t), r = await function(t, e) {
        ...
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.jt(t, e).next((e => e ? n.Mn.pn(t, e) : xs.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
 ...
 */ class Pc extends Rc {
    ...
    async initialize(t) {
        await super.initialize(t), await hr(this.localStore), await this.Qo.initialize(this, t), 
        // Enqueue writes from a previous session
        await Ic(this.Qo.syncEngine), await ho(this.Qo.remoteStore);
    }
    Ko(t) {
        return Xi(this.persistence, new Ji, t.initialUser, this.R);
    }
 ...
 */ class bc extends Pc {
    ...
    async initialize(t) {
        ...
        await this.persistence.He((async t => {
            await _c(this.Qo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Bo(t) {
        const e = Lr();
        if (!Nr.gt(e)) throw new D(S.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class vc {
    ...
    terminate() {
        return async function(t) {
            const e = B(t);
            k("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), await Jr(e), 
            e.Lr.shutdown(), 
...
class Cc {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = B(t), s = Ln(n.R) + "/documents", i = {
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Sc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Co(t, o))), n.fromCache && "server" === s.source ? i.reject(new D(S.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new $o(n, r, {
            includeMetadataChanges: !0,
...
class ru {
    ...
    getToken() {
        ...
        this.getToken()) : e ? (L("string" == typeof e.accessToken), new nu(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
    ...
    hc() {
        ...
        return L(null === t || "string" == typeof t), new Ar(t);
    }
    /**
 ...
 */ class ou {
    constructor(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = Ar.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class cu {
    ...
    getToken() {
        return Promise.resolve(new ou(this.fc, this.dc, this.wc));
    }
    setChangeListener(t, e) {
 ...
 */
        return function(t) {
            const e = eu.get(t);
            e && (k("ComponentProvider", "Removing Datastore"), eu.delete(t), e.terminate());
...
function Eu(t, e, ...n) {
    if (t = y(t), uu("collection", "path", e), t instanceof _u) {
        const s = X.fromString(e, ...n);
        return hu(s), new pu(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof gu || t instanceof pu)) throw new D(S.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Tu(t, e) {
    if (t = fu(t, _u), uu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new D(S.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new yu(t, 
    /* converter= */ null, 
    /**
...
function Iu(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = q.u()), uu("doc", "path", e), t instanceof _u) {
        const s = X.fromString(e, ...n);
 ...
 * Firestore database.
 */ function Au(t, e) {
    return t = y(t), e = y(e), (t instanceof gu || t instanceof pu) && (e instanceof gu || e instanceof pu) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Ru(t, e) {
    return t = y(t), e = y(e), t instanceof yu && e instanceof yu && (t.firestore === e.firestore && le(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Ao.createAndSchedule(this, t, e, n, (t => this.vc(t)));
...
/** A "context" object passed around while parsing user data. */ class ta {
    ...
    Bc(t) {
        return Ea(t, this.settings.methodName, this.settings.Uc || !1, this.path, this.settings.qc);
    }
    ...
    Fc(t) {
        ...
        if (Zu(this.xc) && Ju.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }
}
...
class ca extends zu {
    ...
    _toFieldTransform(t) {
        const e = ra(this, t, 
        /*array=*/ !0), n = this.Qc.map((t => da(t, e))), s = new Pe(n);
...
class ua extends zu {
    ...
    _toFieldTransform(t) {
        const e = ra(this, t, 
        /*array=*/ !0), n = this.Qc.map((t => da(t, e))), s = new ve(n);
        return new Ne(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
/** Parse update data from a list of field/value arguments. */ function la(t, e, n, s, i, r) {
    const o = t.Kc(1 /* Update */ , e, n), c = [ ga(e, s, n) ], u = [ i ];
 ...
 */ function fa(t, e, n, s = !1) {
    return da(n, t.Kc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function da(t, e) {
    ...
    // from firestore-exp.
    t = y(t))) return ma("Unsupported field value:", e, t), wa(t, e);
    if (t instanceof zu) 
 ...
 */
    return function(t, e) {
        ...
        if (!Zu(e.xc)) throw e.Bc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Bc(`Unsupported field value: ${lu(t)}`);
    }
    /**
...
function _a(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof W || t instanceof Hu || t instanceof Gu || t instanceof gu || t instanceof zu);
}
 ...
 */ function ga(t, e, n) {
    ...
    // FieldPath.
    e = y(e)) instanceof ju) return e._internalPath;
 ...
 */ function pa(t, e, n) {
    ...
    /* path= */ void 0, n);
    try {
        return new ju(...e.split("."))._internalPath;
    } catch (s) {
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function Ra(t, e) {
    return "string" == typeof e ? pa(t, e) : e instanceof ju ? e._internalPath : e._delegate._internalPath;
}
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((s => {
                    const i = new va(t._firestore, t._userDataWriter, s.doc.key, s.doc, new Pa(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
 ...
 * limitations under the License.
 */ function Ca(t) {
    if (ie(t) && 0 === t.explicitOrderBy.length) throw new D(S.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class Ma extends Na {
    ...
    _apply(t) {
        return new yu(t.firestore, t.converter, he(t._query, this.Jc, this.Yc));
    }
}
...
function ja(...t) {
    return new Qa("endBefore", t, /*before=*/ !0);
}

function Wa(...t) {
    return new Qa("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Ga(t, e, n, s) {
    if (n[0] = y(n[0]), n[0] instanceof Ia) return function(t, e, n, s, i) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!ce(t) && -1 !== u.indexOf("/")) throw new D(S.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
...
function za(t, e, n) {
    if ("string" == typeof (n = y(n))) {
        ...
        if (!ce(e) && -1 !== n.indexOf("/")) throw new D(S.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
    ...
    throw new D(S.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${lu(n)}.`);
}
 ...
 */ class th {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = y(e)) || e instanceof ju ? la(this._dataReader, "WriteBatch.update", i._key, e, n, s) : ha(this._dataReader, "WriteBatch.update", i._key, e), 
 ...
 */ function ih(t) {
    ...
    return jc(n, t._key).then((n => new ba(e, s, t._key, n, new Pa(null !== n && n.hasLocalMutations, 
...
function hh(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = y(e)) || e instanceof ju ? la(r, "updateDoc", t._key, e, n, s) : ha(r, "updateDoc", t._key, e);
 ...
 */ class gh extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = y(e)) || e instanceof ju ? la(this._dataReader, "Transaction.update", i._key, e, n, s) : ha(this._dataReader, "Transaction.update", i._key, e), 
