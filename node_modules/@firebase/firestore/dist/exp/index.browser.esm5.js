...
var R = {
    ...
    return t(n, e), n;
}(Error), O = new f("@firebase/firestore");
...
function F(t) {
    ...
    if (O.logLevel <= l.DEBUG) {
        var i = n.map(U);
        O.debug.apply(O, e([ "Firestore (" + C + "): " + t ], i));
    }
}

function V(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (O.logLevel <= l.ERROR) {
        var i = n.map(U);
        O.error.apply(O, e([ "Firestore (" + C + "): " + t ], i));
    }
}

function q(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (O.logLevel <= l.WARN) {
        var i = n.map(U);
        O.warn.apply(O, e([ "Firestore (" + C + "): " + t ], i));
    }
}
 ...
 */ var Y = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new L(R.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new L(R.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new L(R.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new L(R.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var tt = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new L(R.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new L(R.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new L(R.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new L(R.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new L(R.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
...
/** Creates a deep copy of `source`. */ function Ct(t) {
    ...
    if (t.timestampValue) return {
        timestampValue: Object.assign({}, ut(t.timestampValue))
    };
    if (t.mapValue) {
        var e = {
            mapValue: {
...
function Mt(t) {
    ...
    if (null === e.h) {
        ...
        n += Yt(e.startAt)), e.endAt && (n += "|ub:", n += Yt(e.endAt)), e.h = n;
    }
    return e.h;
}
...
var qt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new Ut(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Qt(t, r) : "in" /* IN */ === e ? new Gt(t, r) : "not-in" /* NOT_IN */ === e ? new zt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Wt(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
        return "in" /* IN */ === e ? new Bt(t, n) : new jt(t, n);
...
/** Creates a new Query instance with the options provided. */ function ee(t, e, n, r, i, o, s, u) {
    return new te(t, e, n, r, i, o, s, u);
}
 ...
 */ function ae(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Xt(n)), e.p.push(new Xt(rt.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function ce(t) {
    var e = K(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Pt(e.path, e.collectionGroup, ae(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Ht(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new Ht(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.T = Pt(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.T;
}
...
function fe(t, e) {
    return Ft(ce(t), ce(e)) && t.limitType === e.limitType;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function pe(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !Jt(t.startAt, ae(t), e)) && (!t.endAt || !Jt(t.endAt, ae(t), e));
    }(t, e);
}
 ...
 */ function Ie(t, e, n) {
    ...
    }(n, e) : t instanceof _e ? Ne(t, e) : t instanceof De ? Ae(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Ee(t, e), r = Ce(n) + Ce(t.A);
        return _t(n) && _t(t.A) ? ge(r) : me(t.R, r);
    }(t, e);
}
 ...
 */ function Te(t, e, n) {
    ...
    // applications.
    return t instanceof _e ? Ne(t, e) : t instanceof De ? Ae(t, e) : n;
}
 ...
 */ function Ee(t, e) {
    return t instanceof ke ? _t(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var Se = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
}(be), _e = /** @class */ function(e) {
    function n(t) {
        var n = this;
 ...
 */ function Fe(t, e, n) {
    t instanceof je ? function(t, e, n) {
        // Unlike applySetMutationToLocalView, if we're applying a mutation to a
        // remote document the server has accepted the mutation so the precondition
        // must have held.
        var r = t.value.clone(), i = Ge(t.fieldTransforms, e, n.transformResults);
        ...
        if (Pe(t.precondition, e)) {
            var r = Ge(t.fieldTransforms, e, n.transformResults), i = e.data;
 ...
 */ function Ve(t, e, n) {
    t instanceof je ? function(t, e, n) {
        if (Pe(t.precondition, e)) {
            var r = t.value.clone(), i = ze(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Be(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof Ke ? function(t, e, n) {
        if (Pe(t.precondition, e)) {
            var r = ze(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Qe(t)), i.setAll(r), e.convertToFoundDocument(Be(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Pe(t.precondition, e) && 
 ...
 */ function qe(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = Ee(o.transform, s || null);
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && W(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof _e && e instanceof _e || t instanceof De && e instanceof De ? W(t.elements, e.elements, gt) : t instanceof ke && e instanceof ke ? gt(t.A, e.A) : t instanceof Se && e instanceof Se;
 ...
 */ function ze(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, Ie(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var We, He, Ye = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (He = We || (We = {}))[He.OK = 0] = "OK", He[He.CANCELLED = 1] = "CANCELLED", 
...
var tn = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, nn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, nn.BLACK, null, null));
    }, 
...
}(), sn = new tn(vt.comparator);

function un() {
    return sn;
}

var an = new tn(vt.comparator);

function cn() {
    return an;
}

var hn = new tn(vt.comparator);

function fn() {
    return hn;
}

var ln = new rn(vt.comparator);
 ...
 */ var vn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, mn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(X.min(), r, yn(), un(), dn());
    }, t;
}(), mn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(ot.EMPTY_BYTE_STRING, n, dn(), dn(), dn());
    }, t;
}(), gn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Vt(i)) if (0 === n) {
                ...
                // queries.
                var o = new vt(i.path);
                this.tt(e, o, Lt.newNoDocument(o, X.min()));
            } else j(1 === n); else this.ct(e) !== n && (
    ...
    t.prototype.at = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Vt(o.target)) {
                    ...
                    null !== e.H.get(s) || e.ut(i, s) || e.tt(i, s, Lt.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
        ...
        var i = new vn(t, n, this.Y, this.H, r);
        return this.H = un(), this.J = En(), this.Y = new rn(z), i;
    }, 
    /**
    ...
    t.prototype.q = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new rn(z), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.it = function(t) {
        var e = this;
        this.G.set(t, new In), this.W.getRemoteKeysForTarget(t).forEach((function(n) {
...
function xn(t) {
    return j(!!t), X.fromTimestamp(function(t) {
        var e = ut(t);
        return new Y(e.seconds, e.nanos);
    }(t));
}
...
function Pn(t, e) {
    var n = Ln(e);
    if (n.get(1) !== t.databaseId.projectId) throw new L(R.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new L(R.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new vt(qn(n));
}
...
function Fn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? et.emptyPath() : qn(e);
}
...
function Bn(t, e, n) {
    var r = Pn(t, e.name), i = xn(e.updateTime), o = new xt({
        mapValue: {
            fields: e.fields
        }
    }), s = Lt.newFoundDocument(r, i, o);
...
function Kn(t, e) {
    var n = e.currentDocument ? function(t) {
        ...
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) j("REQUEST_TIME" === e.setToServerValue), n = new Se; else if ("appendMissingElements" in e) {
    ...
    if (e.update) {
        e.update.name;
        var i = Pn(t, e.update.name), o = new xt({
            mapValue: {
...
function Gn(t, e) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Hn(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = Hn(e.endAt)), n;
}

function zn(t) {
    var e = Fn(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        j(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = Wn(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new Xt(Zn(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var h = null;
    return n.endAt && (h = Yn(n.endAt)), ee(e, i, u, s, a, "F" /* First */ , c, h);
}
...
function tr(t) {
    return qt.create(Zn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ function ir(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = sr(e)), e = or(t.get(n), e);
    return sr(e);
}
 ...
 */ function ur(t) {
    ...
    var e = t.length;
    if (j(e >= 2), 2 === e) return j("" === t.charAt(0) && "" === t.charAt(1)), et.emptyPath();
...
/** Name of the IndexedDb object store.  */ hr.store = "mutationQueues", 
...
/** Name of the IndexedDb object store.  */ fr.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
fr.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
fr.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
fr.userMutationsKeyPath = [ "userId", "batchId" ];
...
/**
     ...
     */
yr.readTimeIndex = "readTimeIndex", yr.readTimeIndexPath = "readTime", 
/**
     ...
     */
yr.collectionReadTimeIndex = "collectionReadTimeIndex", yr.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
vr.store = "remoteDocumentGlobal", vr.key = "remoteDocumentGlobalKey";
...
mr.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
mr.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
 ...
 */ wr.key = "targetGlobalKey", wr.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ br.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
br.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ Ir.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Tr.store = "bundles", Tr.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Er.store = "namedQueries", Er.keyPath = "name";

// Visible for testing
var Sr = e(e([], e(e([], e(e([], e(e([], [ hr.store, fr.store, lr.store, yr.store, mr.store, cr.store, wr.store, gr.store ]), [ Ir.store ])), [ vr.store ])), [ br.store ])), [ Tr.store, Er.store ]), _r = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Nr = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.ft = new Dr, this.transaction.oncomplete = function() {
            n.ft.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.ft.reject(new Rr(t, e.error)) : n.ft.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Fr(e.target.error);
            n.ft.reject(new Rr(t, r));
        };
    }
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return F("SimpleDb", "Removing database:", t), Pr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r(new Rr(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var n = e.target.error;
                            "VersionError" === n.name ? r(new L(R.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Rr(t, n));
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = r.sent(), e = kr.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), Ar.reject(t);
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Lr(t) {
 ...
 */ var Or = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return F("SimpleDb", "ADD", this.store.name, t, t), Pr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return F("SimpleDb", "DELETE", this.store.name, t), Pr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return F("SimpleDb", "COUNT", this.store.name), Pr(this.store.count());
    ...
    t.prototype.Ft = function(t) {
        var e = this.cursor({});
        return new Ar((function(n, r) {
            e.onerror = function(t) {
                var e = Fr(t.target.error);
                r(e);
 ...
 */ var Ur = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Fe(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && Ve(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && Ve(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = fn(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
...
/** Decodes a remote document from storage locally to a Document. */ function Qr(t, e) {
    if (e.document) return Bn(t.Lt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = vt.fromSegments(e.noDocument.path), r = Yr(e.noDocument.readTime), i = Lt.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = vt.fromSegments(e.unknownDocument.path), s = Yr(e.unknownDocument.version);
        return Lt.newUnknownDocument(o, s);
    }
    return B();
}

/** Encodes a document for storage locally. */ function Gr(t, e, n) {
    var r = zr(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var u = e.key.path.toArray(), a = Hr(e.version), c = e.hasCommittedMutations;
        return new yr(
        /* unknownDocument= */ null, new dr(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = Hr(e.version);
        return new yr(new pr(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Xr(t, e) {
    ...
    return new Ur(e.batchId, u, n, s);
}

/** Decodes a DbTarget into TargetData */ function $r(t) {
    var e, n, r = Yr(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Yr(t.lastLimboFreeSnapshotVersion) : X.min();
    return void 0 !== t.query.documents ? (j(1 === (n = t.query).documents.length), 
    e = ce(ne(Fn(n.documents[0])))) : e = function(t) {
        return ce(zn(t));
    }(t.query), new jr(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, ot.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Jr(t, e) {
    var n, r = Hr(e.snapshotVersion), i = Hr(e.lastLimboFreeSnapshotVersion);
    n = Vt(e.target) ? Qn(t.Lt, e.target) : Gn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new mr(e.targetId, Mt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ function ei(t) {
    return qr(t, Tr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function ni(t) {
    return qr(t, Er.store);
}
 ...
 */ var ri = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), Ar.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Ar.resolve(this.Bt.getEntries(e));
    }, t;
}(), ii = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new rn(et.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new rn(et.comparator)).toArray();
    }, t;
}(), oi = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return si(t).Nt(r).next((function(t) {
 ...
 */
function ci(t, e, n) {
    var r = t.store(fr.store), i = t.store(lr.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ot({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = lr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return Ar.waitFor(o).next((function() {
        return c;
    }));
}
...
var fi = /** @class */ function() {
    ...
    return t.Qt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            j("number" == typeof u);
            for (var a = new Ur(u, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return jn(t.Lt, e);
                })), i = n.mutations.map((function(e) {
                    return jn(t.Lt, e);
                }));
                return new fr(e, n.batchId, n.localWriteTime.toMillis(), r, i);
            }(i.R, i.userId, a), h = [], f = new rn((function(t, e) {
                return z(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = lr.key(i.userId, p.key.path, u);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, lr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.qt.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Kt[u] = a.keys();
            })), Ar.waitFor(h).next((function() {
                return a;
            }));
        }));
        ...
        return di(t).get(e).next((function(t) {
            return t ? (j(t.userId === n.userId), Xr(n.R, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.jt = function(t, e) {
        var n = this;
        return this.Kt[e] ? Ar.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Kt[e] = r, r;
            }
        ...
        return di(t).Ot({
            ...
            e.userId === n.userId && (j(e.batchId >= r), o = Xr(n.R, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return di(t).Nt(fr.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return Xr(e.R, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = lr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return pi(t).Ot({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], c = r[2], h = ur(a);
            ...
            return di(t).get(c).next((function(t) {
                if (!t) throw B();
                j(t.userId === n.userId), o.push(Xr(n.R, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new rn(z), i = [];
        return e.forEach((function(e) {
            var o = lr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = pi(t).Ot({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = ur(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), Ar.waitFor(i).next((function() {
            return n.Wt(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = lr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new rn(z);
        return pi(t).Ot({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = ur(a);
        ...
        return e.forEach((function(e) {
            i.push(di(t).get(e).next((function(t) {
                if (null === t) throw B();
                j(t.userId === n.userId), r.push(Xr(n.R, t));
            })));
        })), Ar.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return ci(t.Mt, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.Gt(e.batchId);
            })), Ar.forEach(r, (function(e) {
    ...
    t.prototype.Gt = function(t) {
        ...
        return this.checkEmpty(t).next((function(n) {
            if (!n) return Ar.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(lr.prefixForUser(e.userId)), i = [];
            return pi(t).Ot({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
 ...
 */ function li(t, e, n) {
    var r = lr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return pi(t).Ot({
        range: o,
        $t: !0
    }, (function(t, n, r) {
 ...
 */ function di(t) {
    return qr(t, fr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function pi(t) {
    return qr(t, lr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function yi(t) {
    return qr(t, hr.store);
}
 ...
 */ var vi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return j(e.targetCount > 0), e.targetCount -= 1, n.Zt(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return gi(t).Ot((function(t, n) {
            var r = $r(n);
            e(r);
        }));
    }, t.prototype.Xt = function(t) {
        return wi(t).get(wr.key).next((function(t) {
            return j(null !== t), t;
        }));
    }, t.prototype.Zt = function(t, e) {
        return wi(t).put(wr.key, e);
    }, t.prototype.te = function(t, e) {
        return gi(t).put(Jr(this.R, e));
    }, 
    /**
    ...
    t.prototype.ee = function(t, e) {
        ...
        return gi(t).Ot({
            range: r,
            index: mr.queryTargetsIndexName
        }, (function(t, n, r) {
            var o = $r(n);
            // After finding a potential match, check that the target is
            // actually equal to the requested target.
                        Ft(e, o.target) && (i = o, r.done());
        })).next((function() {
            return i;
        }));
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = ir(e.path);
            i.push(o.put(new gr(n, s))), i.push(r.referenceDelegate.addReference(t, n, e));
        })), Ar.waitFor(i);
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        var r = this, i = bi(t);
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return Ar.forEach(e, (function(e) {
            var o = ir(e.path);
            return Ar.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = bi(t), i = dn();
        return r.Ot({
            range: n,
            $t: !0
        }, (function(t, e, n) {
            var r = ur(t[1]), o = new vt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = ir(e.path), r = IDBKeyRange.bound([ n ], [ H(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return bi(t).Ot({
 ...
 */
function gi(t) {
    return qr(t, mr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function wi(t) {
    return qr(t, wr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function bi(t) {
    return qr(t, gr.store);
}
 ...
 */ function Ii(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== R.FAILED_PRECONDITION || t.message !== _r) throw t;
 ...
 */ var Ei = /** @class */ function() {
    function t(t) {
        this.ne = t, this.buffer = new rn(Ti), this.se = 0;
    }
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Lr(e = n.sent()) ? (F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        Ar.resolve(ui)) : this.getCacheSize(t).next((function(r) {
    ...
    t.prototype._e = function(t, e) {
        return function(t, e) {
            var n = !1;
            return yi(t).Ft((function(r) {
                return li(t, r, e).next((function(t) {
                    return t && (n = !0), Ar.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n._e(t, s).next((function(e) {
                    ...
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), bi(t).delete([ 0, ir(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Ai = /** @class */ function() {
    ...
    function t() {
        ...
        this.changes = new Ai((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.removeEntry = function(t, e) {
        void 0 === e && (e = null), this.assertNotApplied(), this.changes.set(t, {
            document: Lt.newInvalidDocument(t),
            readTime: e
        });
    }, 
    /**
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? Ar.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Li(t).get(Oi(e)).next((function(t) {
            return n.ge(e, t);
        }));
    }, 
    /**
     ...
     */
    t.prototype.Ee = function(t, e) {
        var n = this, r = un(), i = new tn(vt.comparator);
        return this.pe(t, e, (function(t, e) {
            var o = n.ge(t, e);
            r = r.insert(t, o), i = i.insert(t, hi(e));
        })).next((function() {
            return {
                documents: r,
                Te: i
        ...
        if (e.isEmpty()) return Ar.resolve();
        ...
        var r = this, i = un(), o = e.path.length + 1, s = {};
        if (n.isEqual(X.min())) {
            ...
            var a = e.path.toArray(), c = zr(n);
            s.range = IDBKeyRange.lowerBound([ a, c ], 
            /* open= */ !0), s.index = yr.collectionReadTimeIndex;
        }
        return Li(t).Ot(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var u = Qr(r.R, n);
                e.path.isPrefixOf(u.key.path) ? pe(e, u) && (i = i.insert(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
        ...
        return Ri(t).get(vr.key).next((function(t) {
            return j(!!t), t;
        }));
    }, t.prototype.me = function(t, e) {
        return Ri(t).put(vr.key, e);
    }, 
    /**
    ...
    t.prototype.ge = function(t, e) {
        ...
        return Lt.newInvalidDocument(t);
    }, t;
}(), xi = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new rn((function(t, e) {
            return z(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var u = e.Ae.get(o);
            if (s.document.isValidDocument()) {
                var a = Gr(e.Ie.R, s.document, e.getReadTime(o));
 ...
 */ function Ri(t) {
    return qr(t, vr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Li(t) {
    return qr(t, yr.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Pi = /** @class */ function() {
    function t(t) {
        this.R = t;
    }
    /**
     ...
     */    return t.prototype.Rt = function(t, e, n, r) {
        var i = this;
        j(n < r && n >= 0 && r <= 11);
        var o = new kr("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore(hr.store, {
                ...
                keyPath: fr.keyPath,
                autoIncrement: !0
            }).createIndex(fr.userMutationsIndex, fr.userMutationsKeyPath, {
                unique: !0
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(gr.store), t.deleteObjectStore(mr.store), t.deleteObjectStore(wr.store);
     ...
     */
            return function(t) {
                var e = t.store(wr.store), n = new wr(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, X.min().toTimestamp(), 
                /*targetCount=*/ 0);
                return e.put(wr.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(fr.store).Nt().next((function(n) {
                    t.deleteObjectStore(fr.store), t.createObjectStore(fr.store, {
                        keyPath: fr.keyPath,
                        autoIncrement: !0
                    }).createIndex(fr.userMutationsIndex, fr.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(fr.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return Ar.waitFor(i);
                }));
            ...
            !function(t) {
                ...
                var e = t.objectStore(yr.store);
                e.createIndex(yr.readTimeIndex, yr.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(yr.collectionReadTimeIndex, yr.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(yr.store).Ot((function(t, n) {
            e += hi(n);
        })).next((function() {
            var n = new vr(e);
            return t.store(vr.store).put(vr.key, n);
        }));
    }, t.prototype.Re = function(t) {
        var e = this, n = t.store(hr.store), r = t.store(fr.store);
        return n.Nt().next((function(n) {
            return Ar.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Nt(fr.userMutationsIndex, i).next((function(r) {
                    return Ar.forEach(r, (function(r) {
                        j(r.userId === n.userId);
                        var i = Xr(e.R, r);
                        return ci(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.be = function(t) {
        var e = t.store(gr.store), n = t.store(yr.store);
        return t.store(wr.store).get(wr.key).next((function(t) {
            var r = [];
            return n.Ot((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? Ar.resolve() : function(n) {
                        return e.put(new gr(0, ir(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Ar.waitFor(r);
        ...
        var n = e.store(br.store), r = new ii, i = function(t) {
            if (r.add(t)) {
        ...
        // Index existing remote documents.
                return e.store(yr.store).Ot({
            $t: !0
        }, (function(t, e) {
            var n = new et(t);
            return i(n.popLast());
        })).next((function() {
            return e.store(lr.store).Ot({
                $t: !0
            }, (function(t, e) {
                t[0];
                var n = t[1], r = (t[2], ur(n));
                return i(r.popLast());
            }));
        }));
    }, t.prototype.Ve = function(t) {
        var e = this, n = t.store(mr.store);
        return n.Ot((function(t, r) {
            var i = $r(r), o = Jr(e.R, i);
            return n.put(o);
        }));
    }, t;
}();
...
function Mi(t) {
    ...
    t.createObjectStore(mr.store, {
        keyPath: mr.keyPath
    }).createIndex(mr.queryTargetsIndexName, mr.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(wr.store);
}

var Fi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Vi = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        }, !t.gt()) throw new L(R.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ni(this, i), this.Le = n + "main", this.R = new Kr(a), 
        this.Be = new Cr(this.Le, 11, new Pi(this.R)), this.Ue = new mi(this.referenceDelegate, this.R), 
        this.qt = new oi, this.qe = function(t, e) {
            return new Ci(t, e);
        }(this.R, this.qt), this.Ke = new ti, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new L(R.FAILED_PRECONDITION, Fi);
    ...
    t.prototype.je = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Ui(e).put(new Ir(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return qi(t).get(cr.key).next((function(t) {
            return Ar.resolve(e.tn(t));
        }));
    }, t.prototype.en = function(t) {
        return Ui(t).delete(this.clientId);
    }, 
    /**
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.Nt().next((function(t) {
                            ...
                            // Delete metadata for clients that are no longer considered active.
                                                        return Ar.forEach(r, (function(t) {
    ...
    t.prototype.Ye = function(t) {
        var e = this;
        return this.Ce ? Ar.resolve(!0) : qi(t).get(cr.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Ui(t).Nt().next((function(t) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.hn(), [ 4 /*yield*/ , this.Be.runTransaction("shutdown", "readwrite", [ cr.store, Ir.store ], (function(e) {
                        var n = new Vr(e, x.o);
    ...
    t.prototype.fn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Ui(e).Nt().next((function(e) {
        ...
        return fi.Qt(t, this.R, this.qt, this.referenceDelegate);
        ...
        return this.Be.runTransaction(t, o, Sr, (function(o) {
            return i = new Vr(o, r.Ne ? r.Ne.next() : x.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw V("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new L(R.FAILED_PRECONDITION, _r);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return qi(t).get(cr.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new L(R.FAILED_PRECONDITION, Fi);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        ...
        return n.get(cr.key).next((function(t) {
            return e.tn(t) ? (F("IndexedDbPersistence", "Releasing primary lease."), n.delete(cr.key)) : Ar.resolve();
        }));
    }, 
 ...
 */
function qi(t) {
    return qr(t, cr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Ui(t) {
    return qr(t, Ir.store);
}
 ...
 */
        ...
        return this.qt.getCollectionParents(t, i).next((function(s) {
            return Ar.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new te(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Lt.newInvalidDocument(c), r = r.insert(c, h)), Ve(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (re(e) || ie(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (P() <= l.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), de(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return P() <= l.DEBUG && F("QueryEngine", "Using full collection scan to execute query:", de(e)), 
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.On = X.min(), this._n = t.getMutationQueue(n), this.Fn = t.getRemoteDocumentCache(), 
        this.Ue = t.getTargetCache(), this.Mn = new Ki(this.Fn, this._n, this.persistence.getIndexManager()), 
...
function Hi(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = K(t), i = n._n, o = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new Ki(n.Fn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
 ...
 */ function Yi(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = Ar.resolve();
 ...
 * queue.
 */ function $i(t, e) {
    var n = K(t), r = e.snapshotVersion, i = n.kn;
     ...
     */
        ...
        return Ar.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Mn.En(t, u);
        })).next((function() {
 ...
 */ function to(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ue.getTargetData(t, e).next((function(i) {
            ...
            r = i, Ar.resolve(r)) : n.Ue.allocateTargetId(t).next((function(i) {
                return r = new jr(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Ue.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function eo(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = K(t), o = n.kn.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
 ...
 */ function no(t, e, n) {
    var r = K(t), i = X.min(), o = dn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = K(t), i = r.$n.get(n);
            return void 0 !== i ? Ar.resolve(r.kn.get(i)) : r.Ue.getTargetData(e, n);
        }(r, t, ce(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Ue.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : X.min(), n ? o : dn());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
...
// PORTING NOTE: Multi-Tab only.
function ro(t, e) {
    var n = K(t), r = K(n.Ue), i = n.kn.get(e);
...
function io(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = K(t), i = un(), o = zr(n), s = Li(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
                index: yr.readTimeIndex,
                range: u
            }, (function(t, e) {
            ...
            return [ 2 /*return*/ , (e = K(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    ...
                    // If there are no existing entries, we return SnapshotVersion.min().
                        ...
                        e.readTime && (n = Wr(e.readTime)), r.done();
                    })).next((function() {
                        return n;
                    }));
                }(t);
 ...
 */ function so(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = K(t), s = dn(), u = un(), a = fn(), c = 0, h = i; c < h.length; c++) f = h[c], 
                ...
                return d = n.Fn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , to(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return ce(ne(et.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Ji(t, d, u, X.min(), a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function uo(t, e, i) {
    return void 0 === i && (i = dn()), n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , to(t, ce(Zr(e.bundledQuery))) ];

              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = K(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var r = xn(e.readTime);
 ...
 */ var ao = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Ar.resolve(this.Qn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return Ar.resolve(this.jn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Wn = new rn(ho.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new rn(ho.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new vt(new et([])), r = new ho(n, t), i = new ho(n, t + 1), o = [];
        ...
        var e = new vt(new et([])), n = new ho(e, t), r = new ho(e, t + 1), i = dn();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new ho(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    function t(t, e) {
        ...
        this.rs = new rn(ho.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return Ar.resolve(0 === this._n.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ss;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.rs = this.rs.add(new ho(a.key, i)), this.qt.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return Ar.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return Ar.resolve(this.os(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.cs(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Ar.resolve(this._n.length > i ? this._n[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return Ar.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return Ar.resolve(this._n.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new ho(e, 0), i = new ho(e, Number.POSITIVE_INFINITY), o = [];
        return this.rs.forEachInRange([ r, i ], (function(t) {
            var e = n.os(t.ns);
            o.push(e);
        })), Ar.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new rn(z);
        return e.forEach((function(t) {
            var e = new ho(t, 0), i = new ho(t, Number.POSITIVE_INFINITY);
            n.rs.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.ns);
            }));
        })), Ar.resolve(this.us(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new ho(new vt(i), 0), s = new rn(z);
        ...
        var n = this;
        j(0 === this.hs(e.batchId, "removed")), this._n.shift();
        var r = this.rs;
        return Ar.forEach(e.mutations, (function(i) {
            var o = new ho(i.key, e.batchId);
        ...
        var n = new ho(e, 0), r = this.rs.firstAfterOrEqual(n);
        return Ar.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this._n.length, Ar.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new tn(vt.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Ar.resolve(n ? n.document.clone() : Lt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = un();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Lt.newInvalidDocument(t));
        })), Ar.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = un(), i = new vt(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || pe(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return Ar.resolve(r);
    }, t.prototype.fs = function(t, e) {
        return Ar.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
...
}(ki), yo = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.ds = new Ai((function(t) {
            return Mt(t);
        }), Ft), 
        ...
        /**
             ...
             * IDs.
             */
        this._s = new co, this.targetCount = 0, this.gs = vi.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Ar.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return Ar.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.gs.next(), Ar.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.gs = new vi(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.te(e), this.targetCount += 1, Ar.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), Ar.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this.ds.forEach((function(s, u) {
            ...
            i++);
        })), Ar.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return Ar.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.ds.get(e) || null;
        return Ar.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this._s.Jn(e, n), Ar.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this._s.Xn(e, n);
        ...
        return this._s.Zn(e), Ar.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return Ar.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Ar.resolve(this._s.containsKey(e));
    }, t;
}(), vo = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.ys = {}, this.Ne = new x(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
        this.Ue = new yo(this), this.qt = new ri, this.qe = function(t, e) {
            return new lo(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.qt), this.R = new Kr(e), this.Ke = new ao(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new fo(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.Ue;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return Ar.or(Object.values(this.ys).map((function(n) {
            return function() {
    ...
    return t.Ps = function(e) {
        ...
        return this.As.addReference(n, e), this.bs.delete(n.toString()), Ar.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), Ar.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.bs.add(e.toString()), Ar.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Ar.forEach(this.bs, (function(r) {
            var i = vt.fromPath(r);
        ...
        var n = this;
        return Ar.or([ function() {
            return Ar.resolve(n.As.containsKey(e));
        }, function() {
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function Io(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function To(t, e) {
 ...
 */
// Visible for testing
/** A user with a null UID. */ wo.UNAUTHENTICATED = new wo(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
wo.GOOGLE_CREDENTIALS = new wo("google-credentials-uid"), wo.FIRST_PARTY = new wo("first-party-uid");
...
var Eo = /** @class */ function() {
    ...
    return t.Vs = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new L(o.error.code, o.error.message))), 
    ...
    return t.Vs = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = yn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = yt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.$s = new tn(z), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fs = bo(this.persistenceKey, this.Ns), 
        this.Ms = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.$s = this.$s.insert(this.Ns, new Do), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.gt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ns && (o = this.getItem(bo(this.persistenceKey, i))) && (s = _o.Vs(i, o)) && (this.$s = this.$s.insert(s.clientId, s));
        ...
        // `Window.addEventListener`.
            ...
            if (F("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Fs) return void V("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ls.test(i.key)) {
                                ...
                                return e;
                            }(i.newValue)) !== x.o && this.sequenceNumberHandler(u); else if (i.key === this.Ks) return [ 2 /*return*/ , this.syncEngine.ci() ];
                        } else this.Os.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new Eo(this.currentUser, t, e, n), i = Io(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Ss());
        ...
        var r = To(this.persistenceKey, t), i = new So(t, e, n);
        this.setItem(r, i.Ss());
    ...
    function t() {
        this.li = new Do, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.li = new Do, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.$i = function(t, e, n, r) {
            ...
            s.listenOnce(E.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case S.TIMEOUT:
                        F("Connection", 'RPC "' + t + '" timed out'), o(new L(R.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case S.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new L(u, r.message));
                            } else o(new L(R.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new L(R.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var u = r.createWebChannel(s, o), a = !1, c = !1, h = new Lo({
            Ei: function(t) {
        ...
        return f(u, D.EventType.OPEN, (function() {
            ...
            c || (c = !0, q("Connection", "WebChannel transport errored:", t), h.Vi(new L(R.UNAVAILABLE, "The operation could not be completed")));
 ...
 */ var Vo = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new Vo(t, e)
        /**
    ...
    t.prototype.ur = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new L(R.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (j(void 0 === e || "string" == typeof e), ot.fromBase64String(e || "")) : (j(void 0 === e || e instanceof Uint8Array), 
                    ot.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? R.UNKNOWN : Ze(t.code);
                    return new L(e, t.message || "");
                }(s);
                n = new bn(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Pn(t, a.document.name), h = xn(a.document.updateTime), f = new xt({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = Lt.newFoundDocument(c, h, f), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new gn(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Pn(t, y.document), m = y.readTime ? xn(y.readTime) : X.min(), g = Lt.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new gn([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Pn(t, b.document), T = b.removedTargetIds || [];
                n = new gn([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new $e(S), N = E.targetId;
                n = new wn(N, _);
            }
            return n;
    ...
    n.prototype.mr = function(t) {
        ...
        e.database = Vn(this.R), e.addTarget = function(t, e) {
            ...
            return (n = Vt(r) ? {
                ...
                query: Gn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = kn(t, e.resumeToken) : e.snapshotVersion.compareTo(X.min()) > 0 && (
    ...
    n.prototype.start = function() {
        ...
        j(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (j(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = xn(e)), new Le(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
        ...
        // The first response is always the handshake response
                return j(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, 
        this.listener.Ir();
    }, 
    /**
    ...
    return t(n, e), n.prototype.Pr = function() {
        if (this.Rr) throw new L(R.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
        ...
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return Zo(this) ? (F("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = K(t)).Fr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , zo(e) ];
 ...
 */ function Ho(t, e) {
    var n = K(t), r = ps(n);
    n.Or.delete(e), r.er() && Xo(n, e), 0 === n.Or.size && (r.er() ? r.ir() : Zo(n) && 
...
function Jo(t) {
    return Zo(t) && !ps(t).tr() && t.Or.size > 0;
}
...
function rs(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof bn && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof gn ? t.Ur.X(e) : e instanceof wn ? t.Ur.rt(e) : t.Ur.et(e), i.isEqual(X.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Xi(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new jr(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Yo(t, r);
                        }
              ...
              case 11:
                return F("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , is(t, u) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Fr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , zo(t) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Fr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Go(t) ];
...
function ss(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = K(t), n = ys(e), i = e.$r.length > 0 ? e.$r[e.$r.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , is(e, s) ];
...
function us(t) {
    return Zo(t) && !ys(t).tr() && t.$r.length > 0;
}
...
function hs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = ys(t), n = 0, i = t.$r; n < i.length; n++) o = i[n], e.Er(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function fs(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.$r.shift(), o = Br.from(n, e, i), [ 4 /*yield*/ , os(t, (function() {
...
function ls(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && ys(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return Je(i = e.code) && i !== R.ABORTED ? (n = t.$r.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                ys(t).sr(), [ 4 /*yield*/ , os(t, (function() {
 ...
 */ function ds(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = K(t), e ? (n.Fr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Go(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (i = e) ? [ 3 /*break*/ , 4 ] : (n.Fr.add(2 /* IsSecondary */), [ 4 /*yield*/ , zo(n) ]);
    ...
    t.qr = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.qr.sr(), Jo(t) ? $o(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.qr.stop() ];

                  case 2:
                    e.sent(), ts(t), e.label = 3;
    ...
    t.Kr = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Kr.sr(), [ 4 /*yield*/ , ss(t) ]) : [ 3 /*break*/ , 2 ];
...
var vs = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new Dr, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new L(R.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function ms(t, e) {
    if (V("AsyncQueue", e + ": " + t), Lr(t)) return new L(R.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var gs = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = cn(), this.sortedSet = new tn(this.comparator)
        /**
    ...
    this.queries = new Ai((function(t) {
        return le(t);
    }), fe), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function Es(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = K(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Is), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 3:
                return a = r.sent(), c = ms(a, "Initialization of query '" + de(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), s.Wr && e.Hr(s.Wr) && Ds(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function Ss(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u;
        return r(this, (function(r) {
            return n = K(t), i = e.query, o = !1, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), 
 ...
 */ var As = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = bs.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), ks = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.qn = function(t) {
        return t.metadata.exists ? Bn(this.R, t.document, !1) : Lt.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Rs(t)
        /**
    ...
    return t.prototype.oo = function(t) {
        ...
        for (var e = new Map, n = new Cs(this.R), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , so(this.localStore, new Cs(this.R), this.documents, this.ro.id) ];

                  case 1:
                    t = r.sent(), e = this.co(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , uo(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new ji(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Ls = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = dn(), this.lo = ye(t), this.fo = new gs(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new ws, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = re(this.query) && i.size === this.query.limit ? i.last() : null, c = ie(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), f = pe(n.query, e) ? e : null, l = !!h && n.mutatedKeys.has(h.key), d = !!f && (f.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), re(this.query) || ie(this.query)) for (;s.size > this.query.limit; ) {
            var h = re(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.uo = u, 0 !== o.length || a ? {
            snapshot: new bs(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = dn(), this.fo.forEach((function(e) {
    ...
    t.prototype.Ro = function() {
        return bs.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }, t;
}(), Ms = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.bo = {}, this.vo = new Ai((function(t) {
            return le(t);
        }), fe), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new tn(vt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new co, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.xo = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ko = new Map, this.$o = vi.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , to(n.localStore, ce(e)) ];

              case 2:
                return u = r.sent(), a = n.sharedClientState.addLocalQueryTarget(u.targetId), i = u.targetId, 
                [ 4 /*yield*/ , Us(n, e, i, "current" === a) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && Wo(n.remoteStore, u), r.label = 4;
        ...
        return r(this, (function(l) {
            switch (l.label) {
              case 0:
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view._o(i), n.Nn ? [ 4 /*yield*/ , no(t.localStore, e.query, 
                ...
                }, [ 4 /*yield*/ , no(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), u = new Ps(e, s.Bn), a = u._o(s.documents), c = mn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), Zs(t, i, h.To), f = new Ms(e, i, u), 
...
/** Stops listening to the query. */ function Bs(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = K(t), i = n.vo.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Vo.set(i.targetId, o.filter((function(t) {
                    return !fe(t, e);
                }))), void n.vo.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , eo(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), Ho(n.remoteStore, i.targetId), 
                    $s(n, i.targetId);
                })).catch(Ii) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return $s(n, i.targetId), [ 4 /*yield*/ , eo(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = K(t), i = Y.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), dn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = qe(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new Ke(c.key, h, Rt(h.value.mapValue), Oe.exists(!0)));
                            }
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new tn(z)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , nu(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , ss(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = ms(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
            ...
            switch (r.label) {
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Po = !0 : t.modifiedDocuments.size > 0 ? j(r.Po) : t.removedDocuments.size > 0 && (j(r.Po), 
                    r.Po = !1));
                })), [ 4 /*yield*/ , nu(n, i, e) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = K(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), 
                (s = o && o.key) ? (u = (u = new tn(vt.comparator)).insert(s, Lt.newNoDocument(s, X.min())), 
                a = dn().add(s), c = new vn(X.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new rn(z), u, a), [ 4 /*yield*/ , Ks(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Do = n.Do.remove(s), n.Co.delete(e), eu(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , eo(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return $s(n, e, i);
                })).catch(Ii) ];
...
function zs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = K(t), i = e.batch.batchId, r.label = 1;

              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Yi(n.localStore, e) ];
              ...
              case 2:
                ...
                Xs(n, i, /*error=*/ null), Ys(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , nu(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n._n.lookupMutationBatch(t, e).next((function(e) {
                            return j(null !== e), r = e.keys(), n._n.removeMutationBatch(t, e);
                        })).next((function() {
                            return n._n.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Mn.pn(t, r);
              ...
              case 2:
                ...
                // listen events.
                Xs(n, e, i), Ys(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , nu(n, o) ];
 ...
 */ function Hs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                Zo((n = K(t)).remoteStore) || F("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 3:
                return s = r.sent(), u = ms(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function Xs(t, e, n) {
    var r = K(t), i = r.xo[r.currentUser.toKey()];
...
function Js(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && (Ho(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), eu(t));
}

function Zs(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Ls ? (t.No.addReference(o.key, e), tu(t, o)) : o instanceof Os ? (F("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function eu(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Fs(n)), t.Do = t.Do.insert(n, r), Wo(t.remoteStore, new jr(ce(ne(n.path)), r, 2 /* LimboResolution */ , x.o));
    }
}
...
function nu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = K(t), s = [], u = [], a = [], o.vo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.vo.forEach((function(t, n) {
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Ar.forEach(e, (function(e) {
                                        return Ar.forEach(e.Pn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return Ar.forEach(e.bn, (function(r) {
...
function ru(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = K(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (F("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , Hi(n.localStore, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.ko.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new L(R.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.ko.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , nu(n, i.Ln) ];
...
function iu(t, e) {
    var n = K(t), r = n.Co.get(e);
    if (r && r.Po) return dn().add(r.key);
    var i = dn(), o = n.Vo.get(e);
    if (!o) return i;
 ...
 */ function ou(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , no((n = K(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];
...
function su(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , io((e = K(t)).localStore).then((function(t) {
                return nu(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.jt(t, e).next((function(e) {
                            return e ? n.Mn.pn(t, e) : Ar.resolve(null);
                        }));
                    }));
                }((n = K(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , ss(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                Xs(n, e, o || null), Ys(n, e), function(t, e) {
                    K(K(t)._n).Gt(e);
                }(n.localStore, e)) : B(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , nu(n, s) ];
...
function au(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return pu(n = K(t)), yu(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , cu(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Oo = !0, [ 4 /*yield*/ , ds(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Wo(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                n.Vo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return $s(n, e), eo(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), Ho(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , cu(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Co.forEach((function(t, n) {
                        Ho(e.remoteStore, n);
                    })), e.No.ts(), e.Co = new Map, e.Do = new tn(vt.comparator);
                }(n), n.Oo = !1, [ 4 /*yield*/ , ds(n.remoteStore, !1) ];
...
function cu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = K(t), i = [], o = [], s = 0, u = e, r.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Vo.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , to(n.localStore, ce(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.vo.get(d), [ 4 /*yield*/ , ou(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , ro(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , to(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Us(n, hu(v), a, 
                /*current=*/ !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return s = r.sent(), u = vn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , nu(n, s, u) ];
              ...
              case 6:
                return r.sent(), $s(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function du(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = pu(t)).Oo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.Vo.has(u) ? (
                // A target might have been added in a previous attempt
                F("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , ro(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , to(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Us(n, hu(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Wo(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Vo.has(t) ? [ 4 /*yield*/ , eo(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Ho(n.remoteStore, t), $s(n, t);
                            })).catch(Ii) ] : [ 3 /*break*/ , 2 ];
...
function pu(t) {
    var e = K(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Ks.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = iu.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Gs.bind(null, e), e.bo._r = _s.bind(null, e.eventManager), 
    e.bo.Mo = Ns.bind(null, e.eventManager), e;
}

function yu(t) {
    var e = K(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = zs.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Ws.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Rs(n)), o = new xs(n, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , nu(t, a.wn, 
                    /* remoteEvent */ void 0) ];
...
var mu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Fo(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
        ...
        return Wi(this.persistence, new Gi, t.initialUser, this.R);
    }, t.prototype.Uo = function(t) {
        return new vo(go.Ps, this.R);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), [ 4 /*yield*/ , oo(this.localStore) ];
                  ...
                  case 3:
                    ...
                    return n.sent(), [ 4 /*yield*/ , yu(this.Qo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , ss(this.Qo.remoteStore) ];
        ...
        var e = Bi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ai.withCacheSize(this.cacheSizeBytes) : ai.DEFAULT;
        return new Vi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Po(), Mo(), this.R, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Bo = function(t) {
        return new ko;
    }, i;
}(mu), wu = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.Qo.syncEngine, this.sharedClientState instanceof Ao ? (this.sharedClientState.syncEngine = {
                        ai: uu.bind(null, i),
                        ui: lu.bind(null, i),
                        hi: du.bind(null, i),
                        fn: fu.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.He((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , au(this.Qo.syncEngine, t) ];
        ...
        var e = Po();
        if (!Ao.gt(e)) throw new L(R.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Bi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Ao(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(gu), bu = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = Fo(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Oo(e));
        ...
        }, o = xo.gt() ? new xo : new Co, new Qo(e, n, r, i, o);
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = K(t), F("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , zo(e) ];
 ...
 */ var Tu = /** @class */ function() {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new ks(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    return t.prototype.lookup = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new L(R.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            var n, i, o, s, u, a;
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = K(t), i = Vn(n.R) + "/documents", o = {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Pn(t, e.found.name), r = xn(e.found.updateTime), i = new xt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Lt.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                j(!!e.missing), j(!!e.readTime);
                                                var n = Pn(t, e.missing), r = xn(e.readTime);
                                                return Lt.newNoDocument(n, r);
                                            }(t, e) : B();
                                        }(n.R, t);
        ...
        if (n) {
            ...
            throw new L(R.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new L(R.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.ec = 5, this.Zi = new Vo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Zi.ji((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Su(this.datastore), (e = this.sc(t)) && e.then((function(e) {
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = wo.UNAUTHENTICATED, 
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new L(R.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = ms(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Hi(e.localStore, t) ];
...
function Au(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , ku(t) ];
                    ...
                    return function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return (n = K(t)).asyncQueue.verifyOperationInProgress(), F("RemoteStore", "RemoteStore received new credentials"), 
                                    i = Zo(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.Fr.add(3 /* CredentialChange */), [ 4 /*yield*/ , zo(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Fr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Go(n) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = qs.bind(null, e.syncEngine), 
                n.onUnlisten = Bs.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Tu({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return Ss(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new L(R.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = wo.UNAUTHENTICATED, 
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (j("string" == typeof n.accessToken), new Bu(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.hc = function() {
        ...
        return j(null === t || "string" == typeof t), new wo(t);
    }, 
    /**
    ...
    function t(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = wo.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Gu(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((function() {
            return e(wo.FIRST_PARTY);
        }));
 ...
 */ function Hu(t) {
    if (!vt.isDocumentKey(t)) throw new L(R.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Yu(t) {
    if (vt.isDocumentKey(t)) throw new L(R.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Xu(t) {
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new L(R.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Xu(t);
...
function Ju(t, e) {
    if (e <= 0) throw new L(R.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Zu = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new L(R.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new L(R.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new L(R.INVALID_ARGUMENT, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Zu({}), 
        this._settingsFrozen = !1, t instanceof qu ? (this._databaseId = t, this._credentials = new ju) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new L(R.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new qu(t.options.projectId);
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new L(R.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new L(R.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Zu(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new ju;
            switch (t.type) {
              case "gapi":
                var e = t.client;
                ...
                new zu(e, t.sessionIndex || "0", t.iamToken || null);

              case "provider":
                return t.client;

              default:
                throw new L(R.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Uu.get(t)) && (F("ComponentProvider", "Removing Datastore"), 
        Uu.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function ea(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        if (!s) throw new L(R.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
        t._credentials = new Ku(new Bu(o, new wo(s)));
    }
}
 ...
 */ var na = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, ne(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new na(this.firestore, 
 ...
 */ function oa(t, n) {
    ...
    if (t = I(t), Wu("collection", "path", n), t instanceof ta) {
        var o = et.fromString.apply(et, e([ n ], r));
        return Yu(o), new ia(t, /* converter= */ null, o);
    }
    if (!(t instanceof na || t instanceof ia)) throw new L(R.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = et.fromString.apply(et, e([ t.path ], r)).child(et.fromString(n));
    return Yu(s), new ia(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function sa(t, e) {
    if (t = $u(t, ta), Wu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new L(R.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new ra(t, 
    /* converter= */ null, 
    /**
...
function ua(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = G.u()), Wu("doc", "path", n), t instanceof ta) {
        var o = et.fromString.apply(et, e([ n ], r));
        return Hu(o), new na(t, 
        /* converter= */ null, new vt(o));
    }
    if (!(t instanceof na || t instanceof ia)) throw new L(R.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(et.fromString.apply(et, e([ n ], r)));
    return Hu(s), new na(t.firestore, t instanceof ia ? t.converter : null, new vt(s));
}
 ...
 * Firestore database.
 */ function aa(t, e) {
    return t = I(t), e = I(e), (t instanceof na || t instanceof ia) && (e instanceof na || e instanceof ia) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function ca(t, e) {
    return t = I(t), e = I(e), t instanceof ra && e instanceof ra && t.firestore === e.firestore && fe(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var ha = /** @class */ function() {
    function t() {
        ...
        this.Zi = new Vo(this, "async_queue_retry" /* AsyncQueueRetry */), 
...
var la = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new Dr, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
}(), da = -1, pa = /** @class */ function(e) {
    /** @hideconstructor */
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new ha, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
...
function ya(t, e) {
    ...
    if (n.isInitialized()) throw new L(R.FAILED_PRECONDITION, "Firestore can only be initialized once per app.");
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new L(R.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
...
function ga(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Vu(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Nu(t._credentials, t._queue, r);
}
 ...
 */ function wa(t, e) {
    ka(t = $u(t, pa));
    var n = ma(t), r = t._freezeSettings(), i = new bu;
    return Ia(n, i, new gu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function ba(t) {
    ka(t = $u(t, pa));
    var e = ma(t), n = t._freezeSettings(), r = new bu;
    return Ia(e, r, new wu(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Du(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Au(t, e) ];
...
function Ta(t) {
    var e = this;
    if (t._initialized && !t._terminated) throw new L(R.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    var i = new Dr;
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Cr.gt() ? (e = t + "main", [ 4 /*yield*/ , Cr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Bi(t._databaseId, t._persistenceKey)) ];
 ...
 */ function Sa(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Lu(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = K(t);
                            return e.Fr.delete(0 /* UserDisabled */), Go(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (ma(t = $u(t, pa)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = K(t)).Fr.add(0 /* UserDisabled */), [ 4 /*yield*/ , zo(e) ];
...
function Da(t, e) {
    var i = ma(t = $u(t, pa)), o = new la;
    return function(t, e, i, o) {
        var s = this, u = function(t, e) {
            return function(t, e) {
                return new Eu(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return Iu(t, e);
                if (t instanceof ArrayBuffer) return Iu(new Uint8Array(t), e);
...
function Aa(t, e) {
    ...
    }(ma(t = $u(t, pa)), e).then((function(e) {
        return e ? new ra(t, null, e.query) : null;
    }));
}

function ka(t) {
    if (t._initialized || t._terminated) throw new L(R.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var Ca = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new L(R.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var Ra = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new L(R.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new L(R.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new L(R.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
}(), Pa = /^__.*__$/, Ma = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Ke(t, this.data, this.fieldMask, e, this.fieldTransforms) : new je(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Fa = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var qa = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.kc = function(e) {
        ...
        return oc(t, this.settings.methodName, this.settings.Uc || !1, this.path, this.settings.qc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Va(this.xc) && Pa.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ua = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || Fo(t)
 ...
 * classes.
 */ function Ba(t) {
    var e = t._freezeSettings(), n = Fo(t._databaseId);
    return new Ua(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function ja(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Kc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    ec("Data must be an object, but it was:", s, r);
    var u, a, c = Za(r, s);
    if (o.merge) u = new it(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = nc(e, l[f], n);
            if (!s.contains(d)) throw new L(R.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            sc(h, d) || h.push(d);
        }
...
var Ga = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new Re(t.path, new Se);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(La), za = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(La), Ha = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).jc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new ke(t.R, we(t.R, this.jc));
...
/** Parse update data from an update() call. */ function Ya(t, e, n, r) {
    var i = t.Kc(1 /* Update */ , e, n);
    ec("Data must be an object, but it was:", i, r);
    var o = [], s = xt.empty();
    J(r, (function(t, r) {
        var u = ic(e, t, n);
    ...
    var u = new it(o);
    return new Fa(s, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Xa(t, e, n, r, i, o) {
    var s = t.Kc(1 /* Update */ , e, n), u = [ nc(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new L(R.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) u.push(nc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = xt.empty(), l = u.length - 1; l >= 0; --l) if (!sc(h, u[l])) {
        var d = u[l], p = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new it(h);
    return new Fa(f, m, s.fieldTransforms);
}
 ...
 */ function $a(t, e, n, r) {
    return void 0 === r && (r = !1), Ja(n, t.Kc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ja(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return ec("Unsupported field value:", e, t), Za(t, e);
    if (t instanceof La) 
    ...
    return function(t, e) {
        ...
        if (t instanceof Ra) return {
            bytesValue: kn(e.R, t._byteString)
        };
        if (t instanceof na) {
        ...
        throw e.Bc("Unsupported field value: " + Xu(t));
    }(t, e);
}
...
function tc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Y || t instanceof Oa || t instanceof Ra || t instanceof na || t instanceof La);
}
 ...
 */ function nc(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof Ca) return e._internalPath;
 ...
 * evaluated.
 */ function ic(t, n, r) {
    if (n.search(rc) >= 0) throw oc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (Ca.bind.apply(Ca, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw oc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
...
function oc(t, e, n, r, i) {
    ...
    a += ")"), new L(R.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */ var uc = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new na(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new ac(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(cc("DocumentSnapshot.get", t));
 ...
 */
function cc(t, e) {
    return "string" == typeof e ? ic(t, e) : e instanceof Ca ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var hc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new lc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(cc("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(uc), lc = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(fc), dc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new hc(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new lc(n._firestore, n._userDataWriter, r.key, r, new hc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new L(R.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new lc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new hc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new lc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new hc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function vc(t) {
    if (ie(t) && 0 === t.explicitOrderBy.length) throw new L(R.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var wc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Ba(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new L(R.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            var l = qt.create(i, o, u);
            return function(t, e) {
                if (e.g()) {
                    var n = se(t);
                    if (null !== n && !n.isEqual(e.field)) throw new L(R.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = oe(t);
                    null !== r && Pc(t, e.field, r);
                }
                var i = function(t, e) {
                    for (var n = 0, r = t.filters; n < r.length; n++) {
                        var i = r[n];
 ...
 */
                ...
                throw i === e.op ? new L(R.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new L(R.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
...
var Ic = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new L(R.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new L(R.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new Xt(e, n);
            return function(t, e) {
                if (null === oe(t)) {
...
var Ec = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new ra(t.firestore, t.converter, he(t._query, this.Jc, this.Yc));
    }, n;
}(mc);
 ...
 * @returns The created `Query`.
 */ function Sc(t) {
    return Ju("limit", t), new Ec("limit", t, "F" /* First */)
    /**
...
function _c(t) {
    return Ju("limitToLast", t), new Ec("limitToLast", t, "L" /* Last */);
}
...
var Nc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Rc(t, this.type, this.Xc, this.Zc);
        return new ra(t.firestore, t.converter, function(t, e) {
...
function Cc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new kc("endBefore", t, /*before=*/ !0);
}

function xc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new kc("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Rc(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof uc) return function(t, e, n, r, i) {
        if (!r) throw new L(R.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], s = 0, u = ae(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(St(e, r.key)); else {
                ...
                if (ht(c)) throw new L(R.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new L(R.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Ba(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new L(R.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new L(R.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!ue(t) && -1 !== c.indexOf("/")) throw new L(R.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(et.fromString(c));
                if (!vt.isDocumentKey(h)) throw new L(R.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new vt(h);
                u.push(St(e, f));
            } else {
                var l = $a(n, r, c);
...
function Lc(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        if ("" === n) throw new L(R.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!ue(e) && -1 !== n.indexOf("/")) throw new L(R.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(et.fromString(n));
        if (!vt.isDocumentKey(r)) throw new L(R.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return St(t, new vt(r));
    }
    if (n instanceof na) return St(t, n._key);
    throw new L(R.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Xu(n) + ".");
}
 ...
 * array requirements.
 */ function Oc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new L(R.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new L(R.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function Pc(t, e, n) {
    if (!n.isEqual(e)) throw new L(R.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var Mc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        j(rr(n));
        var r = new qu(n.get(1), n.get(3)), i = new vt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Vc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.convertBytes = function(t) {
        ...
        return new na(this.firestore, /* converter= */ null, e);
    }, n;
}(Mc), qc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Ba(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Uc(t, this._firestore), i = Fc(r.converter, e, n), o = ja(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Oe.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Uc(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Ca ? Xa(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Ya(this._dataReader, "WriteBatch.update", s._key, e), 
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Uc(t, this._firestore);
        return this._mutations = this._mutations.concat(new Ye(e._key, Oe.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new L(R.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function Uc(t, e) {
    if ((t = I(t)).firestore !== e) throw new L(R.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Bc(t) {
    t = $u(t, na);
    var e = $u(t.firestore, pa);
    return Mu(ma(e), t._key).then((function(n) {
        return eh(e, t, n);
    }));
}
 ...
 */ function Kc(t) {
    t = $u(t, na);
    var e = $u(t.firestore, pa), i = ma(e), o = new jc(e);
    return function(t, e) {
        var i = this, o = new Dr;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new L(R.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = ms(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new fc(e, o, t._key, n, new hc(null !== n && n.hasLocalMutations, 
 ...
 */ function Gc(t) {
    t = $u(t, ra);
    var e = $u(t.firestore, pa), n = ma(e), r = new jc(e);
    return vc(t._query), Fu(n, t._query).then((function(n) {
        return new dc(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , no(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Ps(e, n.Bn), s = o._o(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = ms(a, "Failed to execute query '" + e + " against cache"), 
...
function Hc(t, e, n) {
    t = $u(t, na);
    var r = $u(t.firestore, pa), i = Fc(t.converter, e, n);
    return th(r, [ ja(Ba(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Oe.none()) ]);
}

function Yc(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = $u(t, na);
    var o = $u(t.firestore, pa), s = Ba(o);
    return th(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Ca ? Xa(s, "updateDoc", t._key, e, n, r) : Ya(s, "updateDoc", t._key, e)).toMutation(t._key, Oe.exists(!0)) ]);
}
 ...
 */ function Xc(t) {
    return th($u(t.firestore, pa), [ new Ye(t._key, Oe.none()) ]);
}
 ...
 */ function $c(t, e) {
    var n = $u(t.firestore, pa), r = ua(t), i = Fc(t.converter, e);
    return th(n, [ ja(Ba(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Oe.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function Jc(t) {
    ...
    "object" != typeof s[c] || fa(s[c]) || (a = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof na) f = $u(t.firestore, pa), l = ne(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](eh(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = $u(t, ra);
        f = $u(y.firestore, pa), l = y._query;
        var v = new jc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new dc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, vc(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new Tu(o), a = new As(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ function eh(t, e, n) {
    var r = n.docs.get(e._key), i = new jc(t);
    return new fc(t, i, e._key, r, new hc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var nh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Uc(t, this._firestore), i = new jc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new fc(n._firestore, i, r._key, t._document, new hc(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Ba(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Uc(t, this._firestore), r = new Vc(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return B();
            var i = t[0];
            if (i.isFoundDocument()) return new uc(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new uc(e._firestore, r, n._key, null, n.converter);
            throw B();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Uc(t, this._firestore), i = Fc(r.converter, e, n), o = ja(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Ca ? Xa(this._dataReader, "Transaction.update", s._key, e, n, r) : Ya(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new _u(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
 ...
 * writes.
 */ function ch(t) {
    return ma(t = $u(t, pa)), new qc(t, (function(e) {
        return th(t, e);
    }))
    /**
 * Cloud Firestore
...
C = u, a(new h("firestore-exp", (function(t, e) {
    var n = e.options, r = t.getProvider("app-exp").getImmediate(), i = new pa(r, t.getProvider("auth-internal"));
    return n && i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("@firebase/firestore", "2.3.2", undefined);

export { Mc as AbstractUserDataWriter, Ra as Bytes, da as CACHE_SIZE_UNLIMITED, ia as CollectionReference, na as DocumentReference, fc as DocumentSnapshot, Ca as FieldPath, La as FieldValue, pa as FirebaseFirestore, L as FirestoreError, Oa as GeoPoint, la as LoadBundleTask, ra as Query, mc as QueryConstraint, lc as QueryDocumentSnapshot, dc as QuerySnapshot, hc as SnapshotMetadata, Y as Timestamp, nh as Transaction, qc as WriteBatch, $c as addDoc, uh as arrayRemove, sh as arrayUnion, Ta as clearIndexedDbPersistence, oa as collection, sa as collectionGroup, Xc as deleteDoc, ih as deleteField, _a as disableNetwork, ua as doc, xa as documentId, wa as enableIndexedDbPersistence, ba as enableMultiTabIndexedDbPersistence, Sa as enableNetwork, xc as endAt, Cc as endBefore, ma as ensureFirestoreConfigured, th as executeWrite, Bc as getDoc, Kc as getDocFromCache, Qc as getDocFromServer, Gc as getDocs, zc as getDocsFromCache, Wc as getDocsFromServer, va as getFirestore, ah as increment, ya as initializeFirestore, Sc as limit, _c as limitToLast, Da as loadBundle, Aa as namedQuery, Jc as onSnapshot, Zc as onSnapshotsInSync, Tc as orderBy, gc as query, ca as queryEqual, aa as refEqual, rh as runTransaction, oh as serverTimestamp, Hc as setDoc, M as setLogLevel, yc as snapshotEqual, Ac as startAfter, Dc as startAt, Na as terminate, Yc as updateDoc, ea as useFirestoreEmulator, Ea as waitForPendingWrites, bc as where, ch as writeBatch };
