...
function nn(t) {
    ...
    if (!en.has(t)) {
        ...
        new H(e, n, s, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling))), o = Ye(t._databaseId), u = function(t, e, n) {
            return new Je(t, e, n);
        }(t._credentials, i, o);
        en.set(t, u);
    }
...
}), "PUBLIC" /* PUBLIC */)), r("firestore-lite", "2.3.2", "node");
