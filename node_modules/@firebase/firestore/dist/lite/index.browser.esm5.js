 ...
 */ var I = "ok", V = "cancelled", k = "unknown", P = "invalid-argument", D = "deadline-exceeded", N = "not-found", F = "permission-denied", O = "unauthenticated", q = "resource-exhausted", L = "failed-precondition", R = "aborted", C = "out-of-range", U = "unimplemented", j = "internal", x = "unavailable", B = /** @class */ function(e) {
    ...
    t.prototype.h = function() {
        ...
        return S(null === t || "string" == typeof t), new y(t);
    }, 
    /**
...
function(t, e, n, r, i, o, a) {
    ...
    this.forceLongPolling = o, this.autoDetectLongPolling = a;
}, X = /** @class */ function() {
    function t(t, e) {
...
/** Extracts the backend's type order for the provided value. */ function Ft(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Pt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : E();
}
 ...
 */ function Ze(t) {
    ...
    if (!Je.has(t)) {
        ...
        new K(i, o, a, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling))), n = Qe(t._databaseId), r = function(t, e, n) {
            return new We(t, e, n);
        }(t._credentials, e, n);
        Je.set(t, r);
    }
...
function(t) {
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Ee(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Te(t, this.data, e, this.fieldTransforms);
    }, t;
}(), _n = /** @class */ function() {
    function t(t, 
...
/** Parse document data from a set() call. */ function In(t, e, n, r, i, o) {
    ...
    if (o.merge) s = new Et(a.fieldMask), u = a.fieldTransforms; else if (o.mergeFields) {
        ...
        s = new Et(f), u = a.fieldTransforms.filter((function(t) {
 ...
 */ function _r(t) {
    return Ye(Ze((t = at(t, an)).firestore), [ new Se(t._key, be.none()) ]);
}
 ...
 */ var kr = /** @class */ function() {
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new Se(e._key, be.none())), this;
    }, 
    /**
...
}), "PUBLIC" /* PUBLIC */)), c("firestore-lite", "2.3.2", "node");

export { yn as Bytes, un as CollectionReference, an as DocumentReference, Qn as DocumentSnapshot, pn as FieldPath, vn as FieldValue, tn as FirebaseFirestore, B as FirestoreError, gn as GeoPoint, sn as Query, Xn as QueryConstraint, zn as QueryDocumentSnapshot, Wn as QuerySnapshot, wt as Timestamp, Rr as Transaction, kr as WriteBatch, Tr as addDoc, Ir as arrayRemove, Ar as arrayUnion, cn as collection, fn as collectionGroup, _r as deleteDoc, Er as deleteField, ln as doc, mn as documentId, fr as endAt, cr as endBefore, vr as getDoc, gr as getDocs, nn as getFirestore, Vr as increment, en as initializeFirestore, rr as limit, ir as limitToLast, er as orderBy, Jn as query, dn as queryEqual, hn as refEqual, Cr as runTransaction, Sr as serverTimestamp, wr as setDoc, g as setLogLevel, Yn as snapshotEqual, sr as startAfter, ar as startAt, on as terminate, br as updateDoc, rn as useFirestoreEmulator, $n as where, Dr as writeBatch };
