(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('render-and-add-props'), require('lodash/get'), require('immer'), require('lodash/set')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'render-and-add-props', 'lodash/get', 'immer', 'lodash/set'], factory) :
    (factory((global.ReactGoogleCharts = {}),global.React,global.renderAndAddProps,global.get,global.produce,global.set));
}(this, (function (exports,React,renderAndAddProps,get,produce,set) { 'use strict';
