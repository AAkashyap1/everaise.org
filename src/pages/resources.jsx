...
const resources = [
  {
    ...
    description: `This book was adapted from a series of handouts used during the 2021 session of Everaise Academy's 
  ...
  },
  {
    ...
    description: `This book was adapted from a series of handouts used during the 2020 session of Everaise Academy's 
  ...
  },
  {
    ...
    description: `This book is adapted from the series of handouts in the Everaise Academy’s 2021 Astronomy course. 
            ...
            <div className="space-y-12">
              <div className="space-y-5 sm:space-y-4 xl:max-w-none">
                ...
                <p className="text-xl text-gray-500">
                  These books grew out of the curriculum from Everaise Academy
                  courses taught over the past two years. Each book offers a
                  comprehensive, in-depth review of their respective fields,
                  complete with theoretical exposition, detailed walkthroughs to
                  a myriad of example problems, and a wide variety of practice
                  problems with hints and full solutions. They are available at
                  a low cost on Amazon; our students gain digital access for
                  free.
                </p>
              </div>
                  ...
                  >
                    <div className="space-y-6 xl:space-y-10">
                      <div className="flex justify-center">
                        <img
                          className="transform hover:scale-110 object-cover mx-auto h-80 w-80 rounded-full"
                          src={book.image}
                          alt=""
                        />
                      </div>
