          ...
          <div className="">
            <div className="space-y-5 sm:space-y-4 xl:max-w-none">
              ...
              <p className="text-xl text-gray-500">
                Our team is comprised of high school and college students who
                have been successful in a variety of STEM fields, including
                math, physics, and biology. Interested in joining the team?
                Learn more{' '}
                <a
            ...
            <ul className="mt-6 flex jusify-center space-y-4 grid sm:grid-cols-2 sm:gap-6 sm:space-y-0 lg:grid-cols-3 lg:gap-8">
              {current.map((person) => (
                <li
                  key={person.name}
                  className="py-10 px-6 border border-gray-200 shadow-lg text-left rounded-lg xl:px-10"
                >
                          ...
                          {person.gitHubUrl && (
                            <li>
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="mr-1 flex justify-center items-center inline-block text-gray-400 hover:text-gray-300"
                              >
                                <span className="sr-only">GitHub</span>
                                <svg
                                  className="h-6 w-6"
