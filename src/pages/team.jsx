      ...
      <div className="mt-5 bg-white">
        <div className="mx-auto pt-6 pb-12 px-4 max-w-7xl sm:px-6 lg:px-8">
          <div className="">
            ...
            <h2 className="mt-16 text-3xl font-bold text-gray-900 sm:text-4xl">Team Archive</h2>
            <ul className="mt-6 flex jusify-center grid md:grid-cols-2 gap-6 space-y-0 xl:grid-cols-3 lg:gap-8">
              {archive.map((person) => (
                <div className="trans-300 h-full flex items-center shadow-lg rounded-lg border border-gray-200 bg-white px-4 sm:px-6 py-5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3">
                        <ul className="items-center flex space-x-5">
                          {person.gitHubUrl && <li>
                            <a href={person.gitHubUrl} target="_blank" rel="noreferrer" className="mr-1 flex justify-center items-center inline-block text-gray-400 hover:text-gray-300">
                              <span className="sr-only">GitHub</span>
                              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                  fillRule="evenodd"
                          ...
                          {person.linkedInUrl && <li>
                            <a href={person.linkedInUrl} target="_blank" rel="noreferrer" className="mr-1 flex justify-center items-center inline-block text-gray-400 hover:text-gray-300">
                              <span className="sr-only">LinkedIn</span>
                              <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                <path
                                  fillRule="evenodd"
                ...
                /*
                <li key={person.name} className="py-10 px-6 border border-gray-200 shadow-lg text-left rounded-lg xl:px-10">
                  <div className="space-y-6 xl:space-y-10 grid grid-cols-6">
