...
export default function Home() {
  ...
  if (course === 'physics') {
    ...
    secondaryNavigation = [
      ...
      { name: 'Module 4: Fluids and Miscellaneous', disabled: true, href: '4', defaultDoc: 'Usqorf4QBflAmA5yfKpS', icon: DocumentTextIcon },
    ]
  } else if (course === 'math') {
    ...
    secondaryNavigation = [
      ...
      { name: 'Module 3: Combinatorics', disabled: true, href: '3', defaultDoc: 'TnZH8rG9A1GUgExglYgq', icon: DocumentTextIcon },
      { name: 'Module 4: Number Theory', disabled: true, href: '4', defaultDoc: 'nL5lJdfk2IsJYnjYgYy2', icon: DocumentTextIcon },
    ]
