...
export default function Guest() {
  return (
    <Page
      ...
      description="Everaise Academy invites professors from prestigious universities, industry professionals, and top
            ...
            <div className="space-y-12">
              <div className="space-y-5 sm:space-y-4 xl:max-w-none">
                ...
                <p className="text-xl text-gray-500">
                  Everaise Academy invites professors from prestigious
                  universities, industry professionals, and top graduate and
                  undergraduate students to give free talks to the public.
                </p>
              </div>
              <ul className="flex jusify-center space-y-4 grid">
                ...
                <p className="text-xl text-gray-500">
                  All of our guest lectures are conducted via video conferencing
                  software, such as Google Meet. In the case that our meetings
                  reach their maximum capacity, our guest lectures are also live
                  streamed on our{' '}
                  <a
                    target="_blank"
                    rel="noreferrer"
                  ...
                  >
                    <span className="text-indigo-500">YouTube channel</span>
                  </a>{' '}
                  Note that talk dates, times, titles, and descriptions may be
                  subject to change up to one week before the talk.
                </p>
                <p className="text-xl text-gray-500">
              ...
              <ul className="flex jusify-center space-y-4 grid">
                ...
                {speakers.map((person) => (
                  <li
                    key={person.name}
                    className="py-10 border border-gray-200 shadow-lg text-left rounded-lg grid grid-cols-1 md:grid-cols-3"
                  >
                    <div className="space-y-6 xl:space-y-10 mb-3 sm:mb-0">
                      ...
                      <div className="space-y-2 flex justify-center">
                        <div className="font-medium text-lg leading-6 space-y-1">
                          <h3 className="flex text-2xl font-semibold -mt-3 sm:-mt-2 md:-mt-2 lg:-mt-2 xl:-mt-6 mb-2 justify-center text-gray-900">
                            {person.name}
                          </h3>
                          <div className="flex justify-center">
                            <h3 className="flex text-md font-medium leading-6 mx-6 justify-center text-gray-900 text-center">
                              {person.role}
                            </h3>
                          </div>
                          <div className="flex justify-center">
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="mt-2 inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-indigo-100 hover:text-indigo-700 trans-300 text-indigo-500"
                            >
                              <svg
                                aria-hidden="true"
                                focusable="false"
