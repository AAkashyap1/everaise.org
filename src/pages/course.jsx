  ...
  const faqs = [
    {
      ...
      answer: (
        <div>
          <p>
            There is no prerequisite age. Students are advised to take our
            diagnostic exam to decide whether they are ready to take this
            course. As many of the topics covered in our courses are also tested
            on academic competitions, here is a rough guide based on American
            STEM competitions.
          </p>
          {data.prereq}
        </div>
    ...
    },
    {
      ...
      answer: (
        <span>
          This diagnostic quiz is a good indication of the difficulty of this
          course.
          {data.diagnostic ? (
            <a href={data.diagnostic} download className="ml-1 text-blue-500">
              Click to download!
            </a>
          ) : (
            <span className="ml-1 text-blue-500">Coming soon!</span>
          )}
        </span>
      )
    }
                  ...
                  >
                    <div
                      ...
                      className={classNames(
                        item.name === current
                          ? 'bg-gray-100 text-cyan-600 font-semibold'
                    ...
                    <div className="py-10 border border-gray-200 shadow-lg text-left rounded-lg grid grid-cols-1 md:grid-cols-4">
                      <div className="space-y-6 xl:space-y-10">
                        <div className="flex justify-center">
                          <img
                            className="object-cover mx-auto h-72 w-72 md:w-64 md:h-64 md:ml-8 rounded-full"
                            src={data.book.image}
                            alt=""
                          />
                        </div>
                      ...
                      <div className="px-8 md:pl-8 md:pr-16 md:col-span-3">
                        ...
                        <div className="text-gray-900 mt-4 font-medium text-lg">
                          <div className="font-normal text-lg font-semibold text-gray-700">
                            {data.book.people}
                          </div>
                        </div>
                        <div className="text-gray-900 mt-4 font-medium text-lg">
                          <div className="font-normal text-base text-gray-700 italic">
                            The course follows the official Everaise Academy{' '}
                            {' ' + data.name + ' '} book, which includes both
                            problems and solutions. During the course, students
                            receive printable digital handouts that collectively
                            form the entire book. Many of our students to
                            purchase a physical copy of the book upon completing
                            the course.
                          </div>
                        </div>
                      ...
                      <div className="relative">
                        <blockquote className="">
                          <div className="mx-auto text-xl leading-9 font-medium text-gray-700">
                            <p>&ldquo;{data.testimonial.quote}&rdquo;</p>
                          </div>
                          <footer className="mt-8">
                            <div className="md:flex md:items-center md:justify-center">
                              <div className="mt-3 text-center md:mt-0 md:flex md:items-center">
                                ...
                                <svg
                                  className="hidden md:block mx-1 h-5 w-5 text-cyan-600"
                                  fill="currentColor"
                                  viewBox="0 0 20 20"
                                >
