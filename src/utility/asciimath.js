...
t.prototype.sort_symbols = function () {
  var t = function (t, e) {
    return (t = t.asciimath.length) > (e = e.asciimath.length)
      ? -1
      : t < e
      ? 1
      : 0;
...
t.prototype.source = function (t, e) {
  ...
  return (
    void 0 === t && (t = 0),
    arguments.length > 1 ? this._source.slice(t, e) : this._source.slice(t)
  );
};
t.prototype.eof = function (t) {
  // eslint-disable-next-line
  return (
    void 0 === t && (t = 0), (t = this.strip_space(t)) === this._source.length
  );
};
...
t.prototype.consume = function (t) {
  ...
  for (var e = '', a = []; !this.eof(t); ) {
    ...
    if (i) {
      ...
      a.push({ tex: h, pos: t, ttype: 'character' });
      e += h;
      t += 1;
    }
  }
...
t.prototype.subsup = function (t) {
  ...
  var i = '';
  var s = t;
  var r = this.exact('_', t);
  if (r) {
    // eslint-disable-next-line
    if ((e = this.unbracket(this.simple(r.end)))) {
      i = i + '_{' + e.tex + '}';
      s = e.end;
    } else {
      i += '_{}';
...
t.prototype.matrix = function (t) {
  ...
  if (i) {
    var s = a
      ? this.leftright_bracket(i.end, 'right')
      : this.right_bracket(i.end);
    if (s) {
      var r = i.rows
        .map(function (t) {
          return t.tex;
...
t.prototype.matrix_contents = function (t, e) {
  ...
  if (!(void 0 === s || (s <= 1 && a.length <= 1)))
    return { rows: a, end: i, column_desc: r, is_array: c };
};
...
t.prototype.bracketed_expression = function (t) {
  ...
  if (e) {
    ...
    if (a) {
      var i =
        this.right_bracket(a.end) || this.leftright_bracket(a.end, 'right');
      return i
        ? {
  ...
  if (!this.other_constant(t)) {
    ...
    if (r) {
      ...
      if (c) {
        var h =
          this.leftright_bracket(c.end, 'right') || this.right_bracket(c.end);
        if (h)
          return {
...
t.prototype.leftright_bracket = function (t, e) {
  ...
  for (var a = 0, i = this.leftright_brackets; a < i.length; a += 1) {
    ...
    if (r)
      return {
        tex:
          'left' === e ? s.left_tex : 'right' === e ? s.right_tex : s.free_tex,
        pos: t,
        end: r.end,
