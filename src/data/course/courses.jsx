...
const courses = {
  physics: {
    ...
    topics: [
      [
        'Kinematics in One Dimension and Calculus Overview',
    ...
    testimonial: {
      quote:
        'Tons of problem solving skills, different aspects and considerations in advanced researches in the Sciences (via guest lectures), having to communicate with avid learners from all over the world and a brand-new respect and appreciation for Physics!',
      name: 'Felix Yew'
    },
    diagnostic: PhysicsH,
    prereq: (
      <p className="mt-2">
        Physics: Students at or approaching USAPhO qualification or with
        sufficient math or physics background.
      </p>
    )
  },
  biology: {
    ...
    topics: [
      [
        'Fundamentals of Macromolecules',
        'Membrane Structures',
        'Proteins',
        'Cellular Metabolism and Cell Cycle',
        'Signal Transduction',
    ...
    testimonial: {
      quote:
        'The best part of the program were learning something new everyday in a well presented manner through the handouts. I loved how the information in the handout was easy to digest so I could understand them better',
      name: 'Sushrit Pasumarthy'
    },
    diagnostic: BiologyH,
    prereq: (
      <p className="mt-2">
        Biology: Students who have participated in USABO or have completed a
  ...
  math: {
    ...
    topics: [
      ...
      [
        'Bases, Decimal Representations',
        'Primes, Factorizations, GCD/LCM',
        'Modular Arithmetic'
      ]
    ],
    book: {
    ...
    testimonial: {
      quote:
        'The commitment to learning and excellence all for free really stood out. Normally, you would assume people to charge large swaths of money for content of this standard and genre, but the level at which content was presented and the follow-up and help to students was phenomenal and at the same time was free of cost.',
      name: 'Krish Shah'
    },
    diagnostic: Math1H,
    prereq: (
      <p className="mt-2">
        Math 1: Students at or approaching AIME qualification.
      </p>
    )
  },
  astronomy: {
    ...
    topics: [
      ...
      [
        'Orbital Mechanics',
        'Spherical Geometry',
        'Celestial Coordinate Systems 1',
        'Celestial Coordinate System 2',
        'Celestial Coordinate Conversions'
      ],
      [
        'Celestial Timekeeping Systems',
        'Geocentric Planetary Phenomena',
        'Reduction in positional observations',
        'Physics of Stars and Planets',
        'Stellar Evolution'
      ],
      [
        'Stellar Systems',
    ...
    testimonial: {
      quote:
        'The best part about the program was how organized everything was. We got the handout schedule way before the program started, so I always knew what was coming. The handouts were generally well-written and comprehensive as well. The Everaise team clearly put a lot of effort into planning these 5 weeks.',
      name: 'Cindy Yu'
    },
    diagnostic: '',
    prereq: (
      <p className="mt-2">
        Astronomy: Students at or approaching NAO qualification or have a strong
        background in trigonometry.
      </p>
    )
  }
};
