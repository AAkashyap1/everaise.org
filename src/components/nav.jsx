...
const resources = [
  {
    name: 'Contact Us',
    description: 'Get in touch with program coordinators and staff members.',
    link: '/contact',
    icon: MailIcon,
  },
  {
    name: 'FAQ',
    description: `View frequently asked questions about Everaise Academy.`,
    link: '/faq',
                  ...
                  {({ open }) => (
                    <>
                      ...
                      >
                        <Popover.Panel
                          static
                          className="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 -translate-x-1/2"
                        >
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                              {resources.map((item) => (
