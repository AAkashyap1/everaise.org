...
const footerNavigation = {
  ...
  support: [
    ...
    {
      name: 'Donate',
      href: 'https://www.paypal.com/donate?token=KAPurKoSBfXiAiGBJkxGPt7W-A4CqiPqBr2Qr4tAa584T3adV4CI8R48WSl3WpZaxjkOKZpkoB5bAi4A'
    }
  ],
  help: [{ name: 'Contact Us', href: '/contact' }],
  legal: [
    {
      name: 'Privacy',
      href: 'https://docs.google.com/document/d/1N-UYeLVg4Jy2VEXC3Y3v-AHlQOiEYXM8DPsCCNY6Dr0/pub'
    },
    {
      name: 'Terms',
      href: 'https://docs.google.com/document/d/1h5-ytQPE6JCJOIQ-7vqCsxaGxs4bnVqzHOxC3QzkUBM/pub'
    }
  ],
  social: [
    {
    ...
    // },
    {
      ...
      icon: (props) => (
        <svg
          ...
          data-prefix="fab"
          data-icon="linkedin"
          className="svg-inline--fa fa-linkedin fa-w-14 w-5 h-5"
          role="img"
      ...
      <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
          ...
          <div className="mt-12 xl:mt-0">
            ...
            <form onSubmit={submitEmail} className="mt-4 sm:flex sm:max-w-md">
              ...
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-cyan-700 hover:bg-cyan-800"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2022 Everaise Academy Inc., a 501(c)(3) non-profit and
            PVSA-certifying public charity.
          </p>
        </div>
      </div>
    </footer>
