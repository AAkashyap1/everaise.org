...
export default function DeleteModuleModal(props) {
  function deleteModule(e) {
    e.preventDefault();
    props.data.doc(`module-${props.id}`).delete().then(() => {
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Deleting modules is not a recoverable action. All data will be immediately lost and cannot be accessed in the future.
                    </p>
                  </div>
                </div>
              </div>
