...
const settings = [
  {
    name: 'Not Disabled',
    description: 'Students will be able to access this assignment'
  },
  {
    name: 'Disabled',
    description: 'No student will be able to access this assignment'
  }
];
                  ...
                  >
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="mt-1 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <RadioGroup
                          value={
                            assignment.disabled ? settings[1] : settings[0]
                          }
                          onChange={(e) =>
                            setAssignment({
                              ...assignment,
                      ...
                      <div className="mt-4">
                        <span className="relative z-0 inline-flex shadow-sm rounded-md">
                          ...
                          <button
                            ...
                            type="button"
                            className={
                              '-ml-px relative inline-flex items-center px-4 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium ' +
                              (assignment.handouts.length === 0
                                ? 'text-gray-300'
                                : 'text-gray-700') +
